...
//------------------------------------------------------------------------------
//
//  Header: mxarm11_firi.h
//
//  Provides definitions for FIRI module based on Freescale ARM11 chassis.
//
//------------------------------------------------------------------------------

#ifndef __MXARM11_FIRI_H
#define __MXARM11_FIRI_H
...
//------------------------------------------------------------------------------
typedef struct{
    REG32 FIRI_TCR;             // 00: FIRI Tx Control Register
    REG32 FIRI_TCTR;            // 04: FIRI Tx Count Register
    REG32 FIRI_RCR;             // 08: FIRI Rx Control Register
    REG32 FIRI_TSR;             // 0C: FIRI Tx Status Register
    REG32 FIRI_RSR;             // 10: FIRI Rx Status Register
    REG32 FIRI_TXFIFO;          // 14: FIRI Tx FIFO Register
    REG32 FIRI_RXFIFO;          // 18: FIRI Rx FIFO Register
    REG32 FIRI_CR;              // 1C: FIRI Control Register
