...
//------------------------------------------------------------------------------
//
//  Header:  mxarm11_ssi.h
//
//  Provides definitions for the SSI (Synchronous Serial Interface) module
//  based on the Freescale ARM11 chassis.
//
//-----------------------------------------------------------------------------
#ifndef __MXARM11_SSI_H
#define __MXARM11_SSI_H
...
#define SSI_SCR_CLK_IST_HIGH            0       // Clock idle state is ??
#define SSI_SCR_CLK_IST_LOW             1       // Clock idle state is ??
