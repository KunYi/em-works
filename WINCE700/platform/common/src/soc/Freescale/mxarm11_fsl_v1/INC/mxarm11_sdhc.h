...
//REMAINING_NOB
#define SDHC_REMNOB_REMNOB_LSH              0   //Remaining number of block
//REMAINING_BLK_SIZE
#define SDHC_REMBS_REMBS_LSH                0   //Remaining number of byte
...
//REMAINING_NOB
#define SDHC_REMNOB_REMNOB_WID              16  //Remaining number of block
//REMAINING_BLK_SIZE
#define SDHC_REMBS_REMBS_WID                12  //Remaining number of byte
