...
PMIC_STATUS PmicTCLEDEnable(TCLED_MODE mode, FUNLIGHT_BANK bank)
{
    ...
    switch(mode)
    {
        ...
        case TCLED_IND_MODE:
            param.mask = CSP_BITFMASK(MC13783_LED_CTL0_FLBANK1) | CSP_BITFMASK(MC13783_LED_CTL0_FLBANK2) |
				       CSP_BITFMASK(MC13783_LED_CTL0_FLBANK3);
            param.data = CSP_BITFVAL(MC13783_LED_CTL0_FLBANK1, MC13783_LED_CTL0_FLBANK_DISABLE) | 
				     CSP_BITFVAL(MC13783_LED_CTL0_FLBANK2, MC13783_LED_CTL0_FLBANK_DISABLE) |
				     CSP_BITFVAL(MC13783_LED_CTL0_FLBANK3, MC13783_LED_CTL0_FLBANK_DISABLE);			
            break;
...
PMIC_STATUS PmicTCLEDFunLightSetCurrentLevel(FUNLIGHT_BANK bank, FUNLIGHT_CHANNEL channel, TCLED_CUR_LEVEL level)
{
    ...
    {
        DEBUGMSG(ZONE_ERROR, (_T("PmicTCLEDIndicatorSetCurrentLevel:Invalid Parameter\r\n")));
...
PMIC_STATUS PmicTCLEDFunLightSawRamps(FUNLIGHT_BANK bank, TCLED_FUN_SPEED speed)
{
    ...
    switch(speed)
    {
        case TC_OFF:
         ...
         case TC_SLOW:
            param.data = CSP_BITFVAL(MC13783_LED_CTL0_FLPATTERN, MC13783_SAW_RAMPS_SLOW);
            param.mask = CSP_BITFMASK(MC13783_LED_CTL0_FLPATTERN);
            break;

         case TC_FAST:
            param.data = CSP_BITFVAL(MC13783_LED_CTL0_FLPATTERN, MC13783_SAW_RAMPS_FAST);
            param.mask = CSP_BITFMASK(MC13783_LED_CTL0_FLPATTERN);
            break;
    }
...
PMIC_STATUS PmicTCLEDFunLightBlendedBowtie(FUNLIGHT_BANK bank, TCLED_FUN_SPEED speed)
{
    ...
    switch(speed)
    {
        case TC_OFF:
         ...
         case TC_SLOW:
            param.data = CSP_BITFVAL(MC13783_LED_CTL0_FLPATTERN, MC13783_BLENDED_BOWTIE_RAMPS_SLOW);
            param.mask = CSP_BITFMASK(MC13783_LED_CTL0_FLPATTERN);
            break;

         case TC_FAST:
            param.data = CSP_BITFVAL(MC13783_LED_CTL0_FLPATTERN, MC13783_BLENDED_BOWTIE_RAMPS_FAST);
            param.mask = CSP_BITFMASK(MC13783_LED_CTL0_FLPATTERN);
            break;
    }
