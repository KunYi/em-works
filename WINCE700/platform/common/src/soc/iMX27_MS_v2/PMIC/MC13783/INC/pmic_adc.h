...
#define ADC_BATT_SNS_RESISTOR    20   //15 // 20 mOhm  //By KIMG, according to SPEC, 15mOhm seems fault
...
#define ADC_BATT_MAX_CURRENT    100*1000/ADC_BATT_SNS_RESISTOR // 3.3 Amp, -3.3Amp depends on charge/discharge
...
//-----------------------------------------------------------------------------
// Types
//power up/down for Touch Panel
typedef enum _MC13783_TOUCH_POWER_MODE {
    TM_POWERUP = 0,
    TM_POWERDOWN
} PMIC_TOUCH_POWER_MODE;
