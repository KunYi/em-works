                                             ...
                                             PMIC_REGULATOR_VREG_POWER_MODE* powerMode) 
{
    ...
    {
        case VIOHI:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VIOHIMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VIOHISTBY);
            break;

        case VIOLO:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VIOLOMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VIOLOSTBY);
            break;
             
        case VDIG:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VDIGMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VDIGSTBY);
            break;
             
        case VGEN:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VGENMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VGENSTBY);
            break;
             
        case VRFDIG:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VRFDIGMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VRFDIGSTBY);
            break;
             
        case VRFREF:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VRFREFMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VRFREFSTBY);
            break;
             
        case VRFCP:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE0_VRFCPMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE0_VRFCPSTBY);
            break;

        case VSIM:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VSIMMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VSIMSTBY);
            break;
             
        case VESIM:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VESIMMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VESIMSTBY);
            break;
             
        case VCAM:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VCAMMODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VCAMSTBY);
             break;
        ...
        case VRF1:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VRF1MODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VRF1STBY);
             break;
             
        case VRF2:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VRF2MODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VRF2STBY);
             break;
             
        case VMMC1:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VMMC1MODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VMMC1STBY);
             break;
             
        case VMMC2:
             lp = CSP_BITFEXT(temp, MC13783_REG_MODE1_VMMC2MODE);
             stby = CSP_BITFEXT(temp, MC13783_REG_MODE1_VMMC2STBY);
             break;
