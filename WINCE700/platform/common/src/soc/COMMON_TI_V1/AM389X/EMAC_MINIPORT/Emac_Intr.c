    ...
    )
{
    ...
    do
    {
      ...
      BufLen   = pCurDesc->BufOffLen & 0xFFFF;
        ...
        if ( 0 != (Status & EMAC_DSC_FLAG_SOP ))
        {
			...
			{
                DEBUGMSG (DBG_INFO,(L"Error in packet \r\n"));
            }
    ...
    /* Indicate to NDIS */                        
    NdisMIndicateReceivePacket(pAdapter->m_AdapterHandle , NdisPktsArray, PacketArrayCount);
