 ...
 *          failure.
 */
//static inline int vps_fvid2_start(void *handle, void *cmdargs)  // WINCE TEMP
static int vps_fvid2_start(void *handle, void *cmdargs)
{
 ...
 *          failure.
 */
// static inline int vps_fvid2_stop(void *handle, void *cmdargs) // WINCE TEMP
static int vps_fvid2_stop(void *handle, void *cmdargs)
{
 ...
 *         failure.
 */
// static inline int vps_fvid2_setformat(void *handle, struct fvid2_format *fmt) // WINCE TEMP
static int vps_fvid2_setformat(void *handle, struct fvid2_format *fmt)
{
 ...
 *         failure.
 */
// static inline int vps_fvid2_getformat(void *handle, struct fvid2_format *fmt) // WINCE TEMP
static int vps_fvid2_getformat(void *handle, struct fvid2_format *fmt)
{
