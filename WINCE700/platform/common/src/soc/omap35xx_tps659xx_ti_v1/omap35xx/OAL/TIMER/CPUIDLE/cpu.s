...
;
 LEAF_ENTRY OALUpdateCoreFreq
        ...
        moveq       r3, #SDRC_DLLA_STATUS_LOCKED
                                         ...
                                         ;--------------------------------------
                                         ; determine what the SDRAM refresh
                                         ; rate is
        ldrne       r10, [r0, #SDRC_LOW_RFR_FREQ_OFFSET]
        ldreq       r10, [r0, #SDRC_HIGH_RFR_FREQ_OFFSET]
        ldr         r1, [r5, #SDRC_RFR_CTRL_0_OA]
        and         r1, r1, #(1 :SHL: SDRC_RFR_CTRL0_ARE_SHIFT)
        mov         r10, r10 LSL #SDRC_RFR_CTRL0_ARCV_SHIFT
        orr         r10, r10, r1
        ...
        bl          SDRCEnable          
                                         ...
                                         ;--------------------------------------
                                         ; update SDRAM w/ new rfr rate
        str         r10, [r5, #SDRC_RFR_CTRL_0_OA]
        str         r10, [r5, #SDRC_RFR_CTRL_1_OA]
