...
Alg. n-deg 0 : AEC-NS  on the DL and UL paths
Alg. n-deg 1 : EQ Left channel on the DL path
Alg. n-deg 2 : EQ Right channel on the DL path
The ACDN1 contains 2 algorithms:
Alg. n-deg 0 : Compressor on the DL path
Alg. n-deg 1 : Equalizer on the UL path
*/
