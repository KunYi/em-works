// IRQ1Set.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
	...
	printf("IRQ1 Driver Configuration\r\n");
	...
	//
	// CS&ZHL JLY-01-2009: open IRQ1 registry
	//
	...
	//
	// if dwTrueInstall == 1, disable ETA503 function
	//
	if(dwTrueInstall)
	{
		//
		// CS&ZHL JLY-01-2009: open ETA503 registry & disable ETA503
		//
		for( i1=0; i1<nExSerNum; i1++ )
		{
			...
			RegSetValueEx(hKey, _T("TrueInstall"), 0, dwType, (BYTE*)&dwSetting, dwBufLen);
