...
//------------------------------------------------------------------------------
// Defines
// Using large burst size will improve whole system performance significantly.
// But we noticed when this feature is used, in XGA resolution screen, memory starvation
// is very easily to occur on MX51 platform, so we disable it by default.
#define USE_LARGE_BURST_SIZE_BG        0
#define USE_LARGE_BURST_SIZE_FG        0
