...
//  File:  pwm.c
//
//  This file contains the necessary routines interface.
//
//------------------------------------------------------------------------------
...
UINT32 PWMGetChannelPresentMask(VOID)
{
    ...
    return ((HW_PWM_CTRL_RD() & (BM_PWM_CTRL_PWM7_PRESENT |
                                 BM_PWM_CTRL_PWM6_PRESENT |
                                 BM_PWM_CTRL_PWM5_PRESENT |
                                 BM_PWM_CTRL_PWM4_PRESENT |
                    ...
                    UINT32 u32PercentActiveDutyCycle)
{
    ...
    if ((u32HzTimes100 < PWM_MIN_FREQUENCY) || (u32HzTimes100 > PWM_MAX_FREQUENCY))
        goto Exit;
    ...
    BF_CS2n(PWM_ACTIVEn, Channel, INACTIVE, u32PercentActiveDutyCycle, ACTIVE, 0);
...
{
    return((HW_PWM_CTRL_RD() & (BM_PWM_CTRL_PWM7_ENABLE |
                                BM_PWM_CTRL_PWM6_ENABLE |
                                BM_PWM_CTRL_PWM5_ENABLE |
                                BM_PWM_CTRL_PWM4_ENABLE |
                              ...
                              UINT32    *pu32ActiveClocks)
{
    ...
    *pu32ActiveClocks = 0;
    ...
    {
        *pu32ActiveClocks = (u32PercentActiveDutyCycle * (*pu32PeriodClocks) / 100);
