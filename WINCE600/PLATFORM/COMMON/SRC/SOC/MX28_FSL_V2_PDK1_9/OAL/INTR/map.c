...
//  SYSINTR. This is custom implementation for MX28 because there can be
//  additional 32x5 GPIO IRQs . These 160 secondary interrupts
//  generate hardware interrupts IRQ_GPIO0, IRQ_GPIO1, IRQ_GPIO2, IRQ_GPIO3 and 
//  IRQ_GPIO4 respectively.
//  OAL needs to demultiplex these primary IRQs into appropriate
...
//
static UINT32 g_oalSysIntr2Irq[SYSINTR_MAXIMUM][IRQ_PER_SYSINTR];
