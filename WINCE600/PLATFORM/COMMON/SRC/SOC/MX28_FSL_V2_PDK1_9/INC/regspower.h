...
//
//  Header: regspower.h
//  PIO Registers for POWER interface
//------------------------------------------------------------------------------
...
#define REGS_POWER_BASE (DWORD)pv_HWregPOWER
...
#define BM_POWER_CHARGE_RSRVD3      0x00030000
...
#ifndef __LANGUAGE_ASM__
#define BW_POWER_RESET_FASTFALLPSWITCH_OFF(v)   BF_CS1(POWER_RESET, FASTFALLPSWITCHD_OFF, v)
#endif
