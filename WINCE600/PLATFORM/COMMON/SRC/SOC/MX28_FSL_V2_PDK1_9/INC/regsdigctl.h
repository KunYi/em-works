...
//
//  Header: regsdigctl.h
//  PIO Registers for DIGCTL interface
//------------------------------------------------------------------------------
...
#define REGS_DIGCTL_BASE (DWORD)pv_HWregDIGCTL
...
#define BV_DIGCTL_CTRL_SAIF_CLKMUX_SEL__EXTMSTR0    0x2
#define BV_DIGCTL_CTRL_SAIF_CLKMUX_SEL__EXTMSTR1    0x3
...
#define HW_DIGCTL_DEBUG_TRAP_SET(v)    (HW_DIGCTL_DEBUG_TRAP_WR(HW_DIGCTL_DEBUG_TRAP_RD() |  (v)))
#define HW_DIGCTL_DEBUG_TRAP_CLR(v)    (HW_DIGCTL_DEBUG_TRAP_WR(HW_DIGCTL_DEBUG_TRAP_RD() & ~(v)))
#define HW_DIGCTL_DEBUG_TRAP_TOG(v)    (HW_DIGCTL_DEBUG_TRAP_WR(HW_DIGCTL_DEBUG_TRAP_RD() ^  (v)))
#endif
