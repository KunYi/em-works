...
#define _MIN_SAMPLE_X_          0x100
#define _MAX_SAMPLE_X_          0xf70
#define _MIN_SAMPLE_Y_          0x0f0
#define _MAX_SAMPLE_Y_          0xf10

#define _RANGE_SAMPLE_X_                        (_MAX_SAMPLE_X_-_MIN_SAMPLE_X_)
#define _RANGE_SAMPLE_Y_                        (_MAX_SAMPLE_Y_-_MIN_SAMPLE_Y_)

#define _SAMPLE_POINT_X_                        ((_RANGE_SAMPLE_X_)/320)
#define _SAMPLE_POINT_Y_                        ((_RANGE_SAMPLE_Y_)/240)

#define _AD_TORLANCE_X_                         (_SAMPLE_POINT_X_*2) // 23
#define _AD_TORLANCE_Y_                         (_SAMPLE_POINT_Y_*1) // 15
#define _LIMIT_CONFIRM_RETIRES_                 2
#define _DEBOUNCE_SAMPLES_                      4
