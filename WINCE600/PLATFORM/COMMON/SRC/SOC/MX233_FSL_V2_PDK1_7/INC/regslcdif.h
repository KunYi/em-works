...
//
//  Header: regslcdif.h
//  PIO Registers for LCDIF interface
//------------------------------------------------------------------------------
...
#define REGS_LCDIF_BASE (DWORD)pv_HWregLCDIF
...
typedef struct
{
    volatile hw_lcdif_ctrl_t               ctrl             ; UINT32 _reserved0[3];
    volatile hw_lcdif_ctrl1_t              ctrl1            ; UINT32 _reserved1[3];
    volatile hw_lcdif_transfer_count_t     transfer_count   ; UINT32 _reserved2[3];
    volatile hw_lcdif_cur_buf_t            cur_buf          ; UINT32 _reserved3[3];
    volatile hw_lcdif_next_buf_t           next_buf         ; UINT32 _reserved4[3];
    volatile hw_lcdif_pagetable_t          pagetable        ; UINT32 _reserved5[3];
    volatile hw_lcdif_timing_t             timing           ; UINT32 _reserved6[3];
    volatile hw_lcdif_vdctrl0_t            vdctrl0          ; UINT32 _reserved7[3];
    volatile hw_lcdif_vdctrl1_t            vdctrl1          ; UINT32 _reserved8[3];
    volatile hw_lcdif_vdctrl2_t            vdctrl2          ; UINT32 _reserved9[3];
    volatile hw_lcdif_vdctrl3_t            vdctrl3          ; UINT32 _reserved10[3];
    volatile hw_lcdif_vdctrl4_t            vdctrl4          ; UINT32 _reserved11[3];
    volatile hw_lcdif_dvictrl0_t           dvictrl0         ; UINT32 _reserved12[3];
    volatile hw_lcdif_dvictrl1_t           dvictrl1         ; UINT32 _reserved13[3];
    volatile hw_lcdif_dvictrl2_t           dvictrl2         ; UINT32 _reserved14[3];
    volatile hw_lcdif_dvictrl3_t           dvictrl3         ; UINT32 _reserved15[3];
    volatile hw_lcdif_dvictrl4_t           dvictrl4         ; UINT32 _reserved16[3];
    volatile hw_lcdif_csc_coeff0_t         csc_coeff0       ; UINT32 _reserved17[3];
    volatile hw_lcdif_csc_coeff1_t         csc_coeff1       ; UINT32 _reserved18[3];
    volatile hw_lcdif_csc_coeff2_t         csc_coeff2       ; UINT32 _reserved19[3];
    volatile hw_lcdif_csc_coeff3_t         csc_coeff3       ; UINT32 _reserved20[3];
    volatile hw_lcdif_csc_coeff4_t         csc_coeff4       ; UINT32 _reserved21[3];
    volatile hw_lcdif_csc_offset_t         csc_offset       ; UINT32 _reserved22[3];
    volatile hw_lcdif_csc_limit_t          csc_limit        ; UINT32 _reserved23[3];
    volatile hw_lcdif_pin_sharing_ctrl0_t  pin_sharing_ctrl0; UINT32 _reserved24[3];
    volatile hw_lcdif_pin_sharing_ctrl1_t  pin_sharing_ctrl1; UINT32 _reserved25[3];
    volatile hw_lcdif_pin_sharing_ctrl2_t  pin_sharing_ctrl2; UINT32 _reserved26[3];
    volatile hw_lcdif_data_t               data             ; UINT32 _reserved27[3];
    volatile hw_lcdif_bm_error_stat_t      bm_error_stat    ; UINT32 _reserved28[3];
    volatile hw_lcdif_stat_t               stat             ; UINT32 _reserved29[3];
    volatile hw_lcdif_version_t            version          ; UINT32 _reserved30[3];
    volatile hw_lcdif_debug0_t             debug0           ; UINT32 _reserved31[3];
    volatile hw_lcdif_debug1_t             debug1           ; UINT32 _reserved32[3];
} CSP_LCDIF_REG, *PCSP_LCDIF_REG;
