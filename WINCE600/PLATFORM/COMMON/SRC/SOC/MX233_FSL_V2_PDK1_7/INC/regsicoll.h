...
//
//  Header: regsicoll.h
//  PIO Registers for ICOLL interface
//------------------------------------------------------------------------------
...
#define REGS_ICOLL_BASE (DWORD)pv_HWregICOLL

//------------------------------------------------------------------------------
// GENERAL MODULE CONSTANTS
//------------------------------------------------------------------------------
#define ICOLL_IRQ_SOURCES_MAX    128
#define ICOLL_IRQ_UNDEFINED      (-1)
#define ICOLL_MAX_PRIORITY_REG   24

#define GET_PRIORITYREG(IRQNo)                                  ((IRQNo) / 4)
#define GET_PRIORITY_PRIORITY(dwReg, IRQNo)             (((dwReg) >> (((IRQNo) % 4) * 8 + 0)) & 3)
#define GET_PRIORITY_VALUE_PRIORITY(IRQNo, Pri)         (((Pri) & 3) << (((IRQNo) % 4) * 8 + 0))
#define GET_PRIORITY_MASK_PRIORITY(IRQNo)               (3 << (((IRQNo) % 4) * 8 + 0))
#define GET_PRIORITY_MASK_ENABLE(IRQNo)                 (1 << (((IRQNo) % 4) * 8 + 2))
#define GET_PRIORITY_MASK_SOFTIRQ(IRQNo)                (1 << (((IRQNo) % 4) * 8 + 3))
