...
//
//------------------------------------------------------------------------------
#ifndef __MX233_USB_H
#define __MX233_USB_H
...
typedef struct {
    ...
    UINT32 ENDPTCTRL    [4];    //      0x1C4-0x1D0
                                //          *   *           Endpoint Control 1-4
...
#if 0
// We should define bit map for USBPHY interface, which is unique for STMP series
typedef volatile struct {
    UINT32 HW_USBPHY_PWD_RW;                    // 0x0
    UINT32 HW_USBPHY_PWD_SET;                   // 0x4
    UINT32 HW_USBPHY_PWD_CLR;                   // 0x8
    UINT32 HW_USBPHY_PWD_TOG;                   // 0xC

    UINT32 HW_USBPHY_TX_RW;                     // 0x10
    UINT32 HW_USBPHY_TX_SE;                     // 0x14
    UINT32 HW_USBPHY_TX_CL;                     // 0x18
    UINT32 HW_USBPHY_TX_TO;                     // 0x1C

    UINT32 HW_USBPHY_RX_RW;                     // 0x20
    UINT32 HW_USBPHY_RX_SE;                     // 0x24
    UINT32 HW_USBPHY_RX_CL;                     // 0x28
    UINT32 HW_USBPHY_RX_TO;                     // 0x2C

    UINT32 HW_USBPHY_CTRL_RW;                   // 0x30
    UINT32 HW_USBPHY_CTRL_SET;                  // 0x34
    UINT32 HW_USBPHY_CTRL_CLR;                  // 0x38
    UINT32 HW_USBPHY_CTRL_TOG;                  // 0x3C

    UINT32 HW_USBPHY_STATUS_RW;                 // 0x40
    UINT32 RESERVED1[3];                        //

    UINT32 HW_USBPHY_DEBUG_RW;                  // 0x50
    UINT32 HW_USBPHY_DEBUG_SET;                 // 0x54
    UINT32 HW_USBPHY_DEBUG_CLR;                 // 0x58
    UINT32 HW_USBPHY_DEBUG_TOG;                 // 0x5C

    UINT32 HW_USBPHY_DEBUG0_STATUS_RW;          // 0x60
    UINT32 RESERVED2[3];                        //

    UINT32 HW_USBPHY_DEBUG1_RW;                 // 0x70
    UINT32 HW_USBPHY_DEBUG1_SET;                // 0x74
    UINT32 HW_USBPHY_DEBUG1_CLR;                // 0x78
    UINT32 HW_USBPHY_DEBUG1_TOG;                // 0x7C
    UINT32 HW_USBPHY_VERSION_RW;                // 0x80
} CSP_USB_PHY_REG, *PCSP_USB_PHY_REG;

    // detailed bit map
typedef struct _PHY_HW_USBPHY_PWD {
    unsigned int RSVD0 : 10;
    unsigned int TXPWDFS : 1;
    unsigned int TXPWDIBIAS : 1;
    unsigned int TXPWDV2I : 1;
    unsigned int RSVD1 : 4;
    unsigned int RXPWDENV : 1;
    unsigned int RXPWD1PT1 : 1;
    unsigned int RXPWDDIFF : 1;
    unsigned int RXPWDRX : 1;
    unsigned int RSVD2 : 11;
} PHY_HW_USBPHY_PWD_T;

typedef struct _PHY_HW_USBPHY_PWD_SET {
    unsigned int RSVD0 : 10;
    unsigned int TXPWDFS : 1;
    unsigned int TXPWDIBIAS : 1;
    unsigned int TXPWDV2I : 1;
    ...
    unsigned int RXPWDRX : 1;
    unsigned int RSVD2 : 11;
} PHY_HW_USBPHY_PWD_SET_T;

typedef struct _PHY_HW_USBPHY_PWD_CLR {
    unsigned int RSVD0 : 10;
    unsigned int TXPWDFS : 1;
    unsigned int TXPWDIBIAS : 1;
    unsigned int TXPWDV2I : 1;
...
typedef struct _PHY_HW_USBPHY_PWD_TOG {
    unsigned int RSVD0 : 10;
    unsigned int TXPWDFS : 1;
    unsigned int TXPWDIBIAS : 1;
    unsigned int TXPWDV2I : 1;
...
typedef struct _PHY_HW_USBPHY_TX {
    unsigned int D_CAL : 4;
    unsigned int RSVD0 : 4;
    unsigned int TXCAL45DN : 4;
    unsigned int RSVD1 : 1 ;
    unsigned int TXENCAL45DN : 1;
    unsigned int RSVD2 : 2;
    unsigned int TXCAL45DP : 4;
    unsigned int RSVD3 : 1;
    unsigned int TXENCAL45DP : 1;
    unsigned int RSVD4 : 2;
    unsigned int USBPHY_TX_SYNC_MUX : 1;
    unsigned int USBPHY_TX_SYNC_INVERT : 1;
    unsigned int USBPHY_TX_EDGECTRL : 3;
    unsigned int RSVD5 : 3;
} HW_USBPHY_TX_T;

typedef struct _PHY_HW_USBPHY_TX_SE {
    unsigned int D_CAL : 4;
    unsigned int RSVD0 : 4;
    unsigned int TXCAL45DN : 4;
    unsigned int RSVD1 : 1 ;
...
typedef struct _PHY_HW_USBPHY_TX_CL {
    unsigned int D_CAL : 4;
    unsigned int RSVD0 : 4;
    unsigned int TXCAL45DN : 4;
    unsigned int RSVD1 : 1 ;
...
typedef struct _PHY_HW_USBPHY_TX_TO {
    unsigned int D_CAL : 4;
    unsigned int RSVD0 : 4;
    unsigned int TXCAL45DN : 4;
    unsigned int RSVD1 : 1 ;
...
typedef struct _PHY_HW_USBPHY_RX {
    unsigned int ENVADJ : 3;
    unsigned int RSVD0 : 1;
    unsigned int DISCONADJ : 3;
    unsigned int RSVD1 : 15;
    unsigned int RXDBYPASS : 1;
    unsigned int RSVD2 : 9;
} HW_USBPHY_RX_T;

typedef struct _PHY_HW_USBPHY_RX_SE {
    unsigned int ENVADJ : 3;
    unsigned int RSVD0 : 1;
    unsigned int DISCONADJ : 3;
    unsigned int RSVD1 : 15;
...
typedef struct _PHY_HW_USBPHY_RX_CL {
    unsigned int ENVADJ : 3;
    unsigned int RSVD0 : 1;
    unsigned int DISCONADJ : 3;
    unsigned int RSVD1 : 15;
...
typedef struct _PHY_HW_USBPHY_RX_TO {
    unsigned int ENVADJ : 3;
    unsigned int RSVD0 : 1;
    unsigned int DISCONADJ : 3;
    unsigned int RSVD1 : 15;
...
typedef struct _PHY_HW_USBPHY_CTRL {
    unsigned int RSVD0 : 1;
    unsigned int ENHOSTDISCONDETECT : 1;
    unsigned int ENIRQHOSTDISCON : 1;
    unsigned int HOSTDISCONDETECT_IRQ : 1;
    unsigned int ENDEVPLUGINDETECT : 1;
    unsigned int DEVPLUGIN_POLARITY : 1;
    unsigned int RSVD1 : 1;
    unsigned int ENOTGIDDETECT : 1;
    unsigned int RSVD2 : 1;
    unsigned int ENIRQRESUMEDETECT : 1;
    unsigned int RESUME_IRQ : 1;
    unsigned int ENIRQDEVPLUGIN : 1;
    unsigned int DEVPLUGIN_IRQ : 1;
    unsigned int DATA_ON_LRADC : 1;
    unsigned int RSVD3 : 14;
    unsigned int HOST_FORCE_LS_SE0 : 1;
    unsigned int UTMI_SUSPENDM : 1;
    unsigned int CLKGATE : 1;
    unsigned int SFTRST : 1;
} HW_USBPHY_CTRL_T;

typedef struct _PHY_HW_USBPHY_CTRL_SET {
    unsigned int RSVD0 : 1;
    unsigned int ENHOSTDISCONDETECT : 1;
    unsigned int ENIRQHOSTDISCON : 1;
    unsigned int HOSTDISCONDETECT_IRQ : 1;
    ...
    unsigned int CLKGATE : 1;
    unsigned int SFTRST : 1;
} HW_USBPHY_CTRL_SET_T;

typedef struct _PHY_HW_USBPHY_CTRL_CLR {
    unsigned int RSVD0 : 1;
    unsigned int ENHOSTDISCONDETECT : 1;
    unsigned int ENIRQHOSTDISCON : 1;
    unsigned int HOSTDISCONDETECT_IRQ : 1;
    ...
    unsigned int CLKGATE : 1;
    unsigned int SFTRST : 1;
} HW_USBPHY_CTRL_CLR_T;

typedef struct _PHY_HW_USBPHY_CTRL_TOG {
    unsigned int RSVD0 : 1;
    unsigned int ENHOSTDISCONDETECT : 1;
    unsigned int ENIRQHOSTDISCON : 1;
    unsigned int HOSTDISCONDETECT_IRQ : 1;
    ...
    unsigned int CLKGATE : 1;
    unsigned int SFTRST : 1;
} HW_USBPHY_CTRL_TOG_T;

typedef struct _PHY_HW_USBPHY_STATUS {
    unsigned int RSVD0 : 3;
    unsigned int HOSTDISCONDETECT_STATUS : 1;
    unsigned int RSVD1 : 2;
    unsigned int DEVPLUGIN_STATUS : 1;
    unsigned int RSVD2 : 1;
    unsigned int OTGID_STATUS : 1;
    unsigned int RSVD3 : 1;
    unsigned int RESUME_STATUS : 1;
    unsigned int RSVD4 : 21;
};

typedef struct _PHY_HW_USBPHY_DEBUG {
    unsigned int OTGIDPIOLOCK : 1;
    unsigned int DEBUG_INTERFACE_HOLD : 1;
    unsigned int HSTPULLDOWN : 2;
    unsigned int ENHSTPULLDOWN : 2;
    unsigned int RSVD0 : 2;
    unsigned int TX2RXCOUNT : 4;
    unsigned int ENTX2RXCOUNT : 1;
    unsigned int RSVD1 : 3;
    unsigned int SQUELCHRESETCOUNT : 5;
    unsigned int RSVD2 : 3;
    unsigned int ENSQUELCHRESET : 1;
    unsigned int SQUELCHRESETLENGTH : 4;
    unsigned int HOST_RESUME_DEBUG : 1;
    unsigned int CLKGATE : 1;
    unsigned int RSVD3 : 1;
} HW_USBPHY_DEBUG_T;

typedef struct _PHY_HW_USBPHY_DEBUG_SET {
    unsigned int OTGIDPIOLOCK : 1;
    unsigned int DEBUG_INTERFACE_HOLD : 1;
    unsigned int HSTPULLDOWN : 2;
    unsigned int ENHSTPULLDOWN : 2;
    ...
    unsigned int CLKGATE : 1;
    unsigned int RSVD3 : 1;
} HW_USBPHY_DEBUG_SET_T;

typedef struct _PHY_HW_USBPHY_DEBUG_CLR {
    unsigned int OTGIDPIOLOCK : 1;
    unsigned int DEBUG_INTERFACE_HOLD : 1;
    unsigned int HSTPULLDOWN : 2;
    unsigned int ENHSTPULLDOWN : 2;
    ...
    unsigned int CLKGATE : 1;
    unsigned int RSVD3 : 1;
} HW_USBPHY_DEBUG_CLR_T;

typedef struct _PHY_HW_USBPHY_DEBUG_TOG {
    unsigned int OTGIDPIOLOCK : 1;
    unsigned int DEBUG_INTERFACE_HOLD : 1;
    unsigned int HSTPULLDOWN : 2;
    unsigned int ENHSTPULLDOWN : 2;
    ...
    unsigned int CLKGATE : 1;
    unsigned int RSVD3 : 1;
} HW_USBPHY_DEBUG_TOG_T;

typedef struct _PHY_HW_USBPHY_DEBUG0_STATUS { 
    unsigned int LOOP_BACK_FAIL_COUNT : 16;
    unsigned int UTMI_RXERROR_FAIL_COUNT : 10;
    unsigned int SQUELCH_COUNT : 6;
} HW_USBPHY_DEBUG0_STATUS_T;

typedef struct _PHY_HW_USBPHY_DEBUG1 {
    unsigned int DBG_ADDRESS : 4;
    unsigned int RSVD0 : 8;
    unsigned int ENTX2TX : 1;
    unsigned int ENTAILADJVD : 2;
    unsigned int RSVD1 : 17;
} HW_USBPHY_DEBUG1_T;

typedef struct _PHY_HW_USBPHY_DEBUG1_SET {
    unsigned int DBG_ADDRESS : 4;
    unsigned int RSVD0 : 8;
    unsigned int ENTX2TX : 1;
    unsigned int ENTAILADJVD : 2;
    unsigned int RSVD1 : 17;
} HW_USBPHY_DEBUG1_SET_T;

typedef struct _PHY_HW_USBPHY_DEBUG1_CLR {
    unsigned int DBG_ADDRESS : 4;
    unsigned int RSVD0 : 8;
    unsigned int ENTX2TX : 1;
    unsigned int ENTAILADJVD : 2;
    unsigned int RSVD1 : 17;
} HW_USBPHY_DEBUG1_CLR_T;

typedef struct _PHY_HW_USBPHY_DEBUG1_TOG {
    unsigned int DBG_ADDRESS : 4;
    unsigned int RSVD0 : 8;
    unsigned int ENTX2TX : 1;
    unsigned int ENTAILADJVD : 2;
    unsigned int RSVD1 : 17;
} HW_USBPHY_DEBUG1_TOG_T;

typedef struct _PHY_HW_USBPHY_VERSION {
...
typedef struct _USB_ID {
    unsigned int ID : 6;          // Configuration number. This number is set to 0x05
                                  // and indicates that the peripheral is the ARC USB-HS OTG
                                  // High-Speed USB On-The-Go USB 2.0 core.
    unsigned int RSVD0 : 2;
    unsigned int NID : 6;         // Ones complement version of ID[5:0].
    unsigned int RSVD1 : 2;
    unsigned int TAG : 5;
    unsigned int REVISION : 4;    // Revision number of the core
    unsigned int VERSION : 4;
    unsigned int CIVERSION : 3;
} USB_ID_T;
...
typedef struct _USB_HWGENERAL {
    ...
    unsigned int SM : 2;          // VUSB_HS_PHY_SERIAL
...
typedef struct _USB_HWTXBUF {
    ...
    unsigned int RESERVED : 7;    // Reserved. These bits are reserved and should be set to zero.
...
typedef struct _USB_USBSTS {
    ...
    unsigned int UAI : 1;     //
    unsigned int UPI : 1;       //
    unsigned int R4 : 4;        //Reserved. These bits are reserved and should be set to zero.
    unsigned int TI0 : 1;     //
    unsigned int TII : 1;       //
    unsigned int RESERVED : 6;   //Reserved. These bits are reserved and should be set to zero.
} USB_USBSTS_T;
...
typedef struct _USB_USBINTR {
    ...
    unsigned RESERVED : 6;        //Reserved. These bits are reserved and should be set to zero.
} USB_USBINTR_T;
...
typedef struct _USB_TXFILLTUNING { //The fields in this register control performance tuning associated with how the host controller posts data to
                                  ...
                                  //the how much data to post into the FIFO and an estimate for how long that operation should take in the target system.
    unsigned int TXSCHOH : 8;
...
typedef struct _USB_ENDPTPRIME {
    unsigned int PERB : 5;   // Prime Endpoint Receive Buffer 每 R/WS.
    ...
    unsigned int R1 : 11;       //
    unsigned int PETB : 5;   //Prime Endpoint Transmit Buffer 每 R/WS.
...
typedef struct _USB_ENDPTFLUSH {
    unsigned int FERB : 5;   // Flush Endpoint Receive Buffer 每 R/WS.
                             ...
                             // Bit 0 每 Endpoint #0
    unsigned int R1 : 11;       //
    unsigned int FETB : 5;   //Flush Endpoint Transmit Buffer 每 R/WS.
...
typedef struct _USB_ENDPTSTAT {
    unsigned int ERBR : 5;   // Endpoint Receive Buffer Ready -- Read Only.
                             ...
                             // ERBR[0]每 Endpoint #0
    unsigned int R1 : 11;       //
    unsigned int ETBR : 5;   // Endpoint Transmit Buffer Ready -- Read Only.
                             // One bit for each endpoint indicates status of the respective endpoint buffer. This bit is set to a one by the
                             // hardware as a response to receiving a command from a corresponding bit in the ENDPTPRIME register. There will always be a delay between setting a bit in the
                             // ENDPTPRIME register and endpoint indicating ready. This delay time varies based upon the current USB traffic and the number of bits set in the
                             // ENDPTPRIME register. Buffer ready is cleared by USB reset, by the USB DMA system, or through the ENDPTFLUSH register.
...
typedef struct _USB_ENDPTCOMPLETE {
    unsigned int ERCE : 5;   // Endpoint Receive Complete Event 每 RW/C.
                             ...
                             // ERCE[0]每 Endpoint #0
    unsigned int R1 : 11;       //
    unsigned int ETCE : 5;   // Endpoint Transmit Complete Event 每 R/WC.
...
typedef struct _USB_ENDPTNAKEN {
    unsigned int EPRNE : 5;   //Each bit is an enaable bit for te
    ...
    //Bit 0 ?Endpoint #0
    unsigned int R1 : 11;       //
    unsigned int EPTNE : 5;   //Each bit is an enaable bit for te
