...
//-----------------------------------------------------------------------------------------------------------
//
// CS&ZHL APR-1-2012: 该地址主要用作Eboot的数据缓冲区，所以指向*.bib中规定的可用RAM的起始地址(0x4020_0000)
//
...
// CS&ZHL DEC-7-2011: EM9280 use 128MB for OS images
//#define IMAGE_BOOT_NANDDEV_RESERVED_SIZE	(DWORD)(128 * 1024 * 1024)
//
// CS&ZHL JAN-5-2012: adjust size of OS images = 127MB in EM9280
//
//#define IMAGE_BOOT_NANDDEV_RESERVED_SIZE	(DWORD)(127 * 1024 * 1024)
//
// CS&ZHL FEB-23-2012: adjust size of OS images = (6MB + 48MB) = 54MB in EM9280
//
#define IMAGE_BOOT_NANDDEV_RESERVED_SIZE	(DWORD)(54 * 1024 * 1024)
...
#define IMAGE_BOOT_DBBT_NAND_BLOCKS         (2)

// EBOOT image
#define IMAGE_BOOT_BOOTIMAGE_NAND_OFFSET    (IMAGE_BOOT_DBBT_NAND_OFFSET + IMAGE_BOOT_DBBT_NAND_BLOCKS)				// = 0x00A
//#define IMAGE_BOOT_BOOTIMAGE_NAND_BLOCKS    (512)
//
// CS&ZHL JAN-5-2012: reduce EBoot space to 12 blocks, Eboot size < 3 blocks (384KB)
//
#define IMAGE_BOOT_BOOTIMAGE_NAND_BLOCKS    (12)

// Boot configuration
#define IMAGE_BOOT_BOOTCFG_NAND_OFFSET      (IMAGE_BOOT_BOOTIMAGE_NAND_OFFSET + IMAGE_BOOT_BOOTIMAGE_NAND_BLOCKS)	// = 0x016, //= 0x20A
#define IMAGE_BOOT_BOOTCFG_NAND_BLOCKS      (2)			// CS&ZHL JAN-5-2012: add a reserved block, (1)

// UUID
#define IMAGE_BOOT_UUID_NAND_OFFSET         (IMAGE_BOOT_BOOTCFG_NAND_OFFSET+IMAGE_BOOT_BOOTCFG_NAND_BLOCKS)			// = 0x018, //= 0x20B
...
//
#define IMAGE_BOOT_SPLASH_NAND_OFFSET       (IMAGE_BOOT_UUID_NAND_OFFSET+IMAGE_BOOT_UUID_NAND_BLOCKS)				// = 0x01A
#define IMAGE_BOOT_SPLASH_NAND_BLOCKS       (6)			

// NK image
//#define IMAGE_BOOT_NKIMAGE_NAND_OFFSET      (IMAGE_BOOT_UUID_NAND_OFFSET+IMAGE_BOOT_UUID_NAND_BLOCKS)				// = 0x20C
//#define IMAGE_BOOT_NKIMAGE_NAND_SIZE        (32 * 1024 * 1024)
//
// CS&ZHL JAN-5-2012: allocate 64MB for NK image
//
//#define IMAGE_BOOT_NKIMAGE_NAND_OFFSET      (IMAGE_BOOT_SPLASH_NAND_OFFSET+IMAGE_BOOT_SPLASH_NAND_BLOCKS)			// = 0x020
//#define IMAGE_BOOT_NKIMAGE_NAND_SIZE        (64 * 1024 * 1024)

//
// CS&ZHL DEC-13-2011: add FATFS configuration info 
//
//#define IMAGE_FILE_SYSTEM_NAND_OFFSET		(0x408)				// FATFS_START = 0x408 * 0x20000 = 0x0810_0000
...
//
//
#define IMAGE_BOOT_VENDOR_ID_OFFSET			(IMAGE_BOOT_SPLASH_NAND_OFFSET+IMAGE_BOOT_SPLASH_NAND_BLOCKS)			// = 0x020
#define IMAGE_BOOT_VENDOR_ID_BLOCKS			(4)			
#define IMAGE_BOOT_USER_ID_OFFSET			(IMAGE_BOOT_VENDOR_ID_OFFSET+IMAGE_BOOT_VENDOR_ID_BLOCKS)				// = 0x024
#define IMAGE_BOOT_USER_ID_BLOCKS			(4)			
#define IMAGE_BOOT_FUTURE_USE_OFFSET		(IMAGE_BOOT_USER_ID_OFFSET+IMAGE_BOOT_USER_ID_BLOCKS)					// = 0x028
#define IMAGE_BOOT_FUTURE_USE_BLOCKS		(6)			

// CS&ZHL MAR-28-2012: allocate 2 blocks for MBR
#define IMAGE_BOOT_MBR_NAND_OFFSET			(IMAGE_BOOT_FUTURE_USE_OFFSET+IMAGE_BOOT_FUTURE_USE_BLOCKS)				// = 0x02E
#define IMAGE_BOOT_MBR_NAND_BLOCKS			(2)			

#define IMAGE_BOOT_NKIMAGE_NAND_OFFSET      (IMAGE_BOOT_MBR_NAND_OFFSET+IMAGE_BOOT_MBR_NAND_BLOCKS)					// = 0x030 -> 0x600000 -> 6MB
#define IMAGE_BOOT_NKIMAGE_NAND_BLOCKS		(384)																	// 384 => 0x180
#define IMAGE_BOOT_NKIMAGE_NAND_SIZE        (48 * 1024 * 1024)														// 0x180 * 128KB => 48MB
#define IMAGE_BOOT_NK_TRUE_SIZE_OFFSET		(IMAGE_BOOT_NKIMAGE_NAND_OFFSET + IMAGE_BOOT_NKIMAGE_NAND_BLOCKS)		// = 0x1B0
#define IMAGE_BOOT_NK_TRUE_SIZE_BLOCKS		(8)
#define IMAGE_FILE_SYSTEM_NAND_OFFSET		(IMAGE_BOOT_NK_TRUE_SIZE_OFFSET + IMAGE_BOOT_NK_TRUE_SIZE_BLOCKS)		// = 0x1B8 => FATFS_SIZE = 73MB(K9F1G08)

//----------------------------------------------------------------------------------------------------------------
// Define a special unused SOC address range that can be used to detect when an image is destined for NAND flash
// 
...
//
// CS&ZHL DEC-8-2011: comments -> IMAGE_BOOT_NANDDEV_NAND_PA_START = 0x80200000
//                             -> IMAGE_BOOT_BOOTIMAGE_NAND_PA_START = 0x80200000 + 0x100000 = 0x80300000
//                             -> IMAGE_BOOT_NKIMAGE_NAND_PA_START = 0x80300000 + 0x3F00000 = 0x84200000
//
// MAR-29-2012: 该地址用作NandFlash映像文件的标志，即若一个映像文件是指向这个地址的，表示该文件应写入NandFlash
//
...
// 
// CS&ZHL MAR-08-2012: 增加对于NANDFLASH标志地址的CA、UA地址的定义。-->0x84200000
//
