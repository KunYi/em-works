...
public:
	...
	LPCUSB_INTERFACE GetTargetInterface (int targetinterface) { return m_lpTargetInterface_1414[targetinterface]; };
private:
    LPCUSB_INTERFACE m_lpTargetInterface;	
	LPCUSB_INTERFACE m_lpTargetInterface_1414[4];
};


// Function Implementation.
// #define NUM_OF_IN_TRANSFER 4 //ravi - chnaged from 4 to 1, to see if this avoids loss of data in MDD
#define NUM_OF_IN_TRANSFER 1
