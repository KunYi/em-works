...
#define TVE_IOCTL_SET_HD_CGMS_A              CTL_CODE(FILE_DEVICE_UNKNOWN, 8014, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define TVE_IOCTL_SET_HD_CGMS_B              CTL_CODE(FILE_DEVICE_UNKNOWN, 8015, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
typedef struct
{
    ...
    UINT32 reserved:1;      // should be set 0
...
// To define this struct based on HD CGMS Type A specification
typedef struct
{
    UINT32 data:20;
    UINT32 dummy:12;

} TVEHDCgmsA, *PTVEHDCgmsA;
...
{
    union {
        TVEHDCgmsA  cgms_a_f1;
        UINT32      f1_data;
    }; 
    
    union {
        TVEHDCgmsA  cgms_a_f2;
        UINT32      f2_data;
    };
        
} TVEHDCgmsAInfo, *PTVEHDCgmsAInfo;
#pragma warning( default : 4201 )
...
typedef struct
{
    ...
    UINT32 f2_data_2;
    UINT32 f2_data_3;
} TVEHDCgmsBInfo, *PTVEHDCgmsBInfo;
...
BOOL   TVESetHDCgmsA(HANDLE hTVE, TVEHDCgmsAInfo *pCgmsInfo);
BOOL   TVESetHDCgmsB(HANDLE hTVE, TVEHDCgmsBInfo *pCgmsInfo);
