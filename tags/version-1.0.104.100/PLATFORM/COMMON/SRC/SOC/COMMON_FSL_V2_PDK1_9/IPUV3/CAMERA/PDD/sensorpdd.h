...
#define CAMERA1_HW_STOP   L"Camera1 HW Stop"
#define CAMERA2_HW_STOP   L"Camera2 HW Stop"
...
private:
    ...
    static void DualCameraAsycThread(LPVOID);
    void DualCameraAsycLoop();
    HANDLE             m_hCamera1HWStop;
    HANDLE             m_hCamera2HWStop;
    HANDLE             m_hDualCameraAsyc;
    HANDLE             m_hDualCameraAsycExit;
