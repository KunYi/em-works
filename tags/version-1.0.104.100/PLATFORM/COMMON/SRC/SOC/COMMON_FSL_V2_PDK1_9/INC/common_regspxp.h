...
//------------------------------------------------------------------------------
//
//  Header: common_regspxp.h
//  PIO Registers for PXP interface
//------------------------------------------------------------------------------
...
#ifndef _COMMON_REGSPXP_H
#define _COMMON_REGSPXP_H  1

typedef unsigned int reg32_t;
typedef unsigned short reg16_t;
typedef unsigned char reg8_t;

#define REGS_PXP_BASE (DWORD)pv_HWregPXP
...
//--- Register HW_PXP_CTRL, field OUTPUT_FORMAT

#define BP_PXP_CTRL_OUTPUT_FORMAT      4
#define BM_PXP_CTRL_OUTPUT_FORMAT      0x000000F0

#define BF_PXP_CTRL_OUTPUT_FORMAT(v)   (((v) << 4) & BM_PXP_CTRL_OUTPUT_FORMAT)

#ifndef __LANGUAGE_ASM__
#define BW_PXP_CTRL_OUTPUT_FORMAT(v)   BF_CS1(PXP_CTRL, OUTPUT_FORMAT, v)
#endif
...
#define HW_PXP_OUTBUF_ADDR      (REGS_PXP_BASE + 0x00000020)
...
////////////////////////////////////////////////////////////////////////////////
//// HW_PXP_OUTBUF2 - Output Frame Buffer Pointer
////////////////////////////////////////////////////////////////////////////////
...
#define HW_PXP_OUTBUF2_ADDR      (REGS_PXP_BASE + 0x00000030)
...
#define HW_PXP_OUTSIZE_ADDR      (REGS_PXP_BASE + 0x00000040)
...
} hw_pxp_s0scale_mx23_t;
#endif


//
// constants & macros for entire HW_PXP_S0SCALE_MX23 register
//

#define HW_PXP_S0SCALE_MX23_ADDR      (REGS_PXP_BASE + 0x000000B0)

#ifndef __LANGUAGE_ASM__
#define HW_PXP_S0SCALE_MX23           (*(volatile hw_pxp_s0scale_mx23_t *) HW_PXP_S0SCALE_MX23_ADDR)
#define HW_PXP_S0SCALE_MX23_RD()      (HW_PXP_S0SCALE_MX23.U)
#define HW_PXP_S0SCALE_MX23_WR(v)     (HW_PXP_S0SCALE_MX23.U = (v))
#define HW_PXP_S0SCALE_MX23_SET(v)    (HW_PXP_S0SCALE_MX23_WR(HW_PXP_S0SCALE_MX23_RD() |  (v)))
#define HW_PXP_S0SCALE_MX23_CLR(v)    (HW_PXP_S0SCALE_MX23_WR(HW_PXP_S0SCALE_MX23_RD() & ~(v)))
#define HW_PXP_S0SCALE_MX23_TOG(v)    (HW_PXP_S0SCALE_MX23_WR(HW_PXP_S0SCALE_MX23_RD() ^  (v)))
#endif


//
// constants & macros for individual HW_PXP_S0SCALE_MX23 bitfields
//

//--- Register HW_PXP_S0SCALE_MX23, field YSCALE

#define BP_PXP_S0SCALE_MX23_YSCALE      16
#define BM_PXP_S0SCALE_MX23_YSCALE      0x3FFF0000

#define BF_PXP_S0SCALE_MX23_YSCALE(v)   (((v) << 16) & BM_PXP_S0SCALE_MX23_YSCALE)

#ifndef __LANGUAGE_ASM__
#define BW_PXP_S0SCALE_MX23_YSCALE(v)   BF_CS1(PXP_S0SCALE_MX23, YSCALE, v)
#endif

//--- Register HW_PXP_S0SCALE_MX23, field XSCALE

#define BP_PXP_S0SCALE_MX23_XSCALE      0
#define BM_PXP_S0SCALE_MX23_XSCALE      0x00003FFF

#define BF_PXP_S0SCALE_MX23_XSCALE(v)   (((v) << 0) & BM_PXP_S0SCALE_MX23_XSCALE)

#ifndef __LANGUAGE_ASM__
#define BW_PXP_S0SCALE_MX23_XSCALE(v)   BF_CS1(PXP_S0SCALE_MX23, XSCALE, v)
#endif
...
} hw_pxp_s0scale_mx28_t;
#endif

/*
 * constants & macros for entire HW_PXP_S0SCALE_MX28 register
 */
#define HW_PXP_S0SCALE_MX28_ADDR         (REGS_PXP_BASE + 0xb0)

#ifndef __LANGUAGE_ASM__
#define HW_PXP_S0SCALE_MX28           (*(volatile hw_pxp_s0scale_mx28_t *) HW_PXP_S0SCALE_MX28_ADDR)
#define HW_PXP_S0SCALE_MX28_RD()      (HW_PXP_S0SCALE_MX28.U)
#define HW_PXP_S0SCALE_MX28_WR(v)     (HW_PXP_S0SCALE_MX28.U = (v))
#define HW_PXP_S0SCALE_MX28_SET(v)    (HW_PXP_S0SCALE_MX28_WR(HW_PXP_S0SCALE_MX28_RD() |  (v)))
#define HW_PXP_S0SCALE_MX28_CLR(v)    (HW_PXP_S0SCALE_MX28_WR(HW_PXP_S0SCALE_MX28_RD() & ~(v)))
#define HW_PXP_S0SCALE_MX28_TOG(v)    (HW_PXP_S0SCALE_MX28_WR(HW_PXP_S0SCALE_MX28_RD() ^  (v)))
#endif


/*
 * constants & macros for individual HW_PXP_S0SCALE_MX28 bitfields
 */
/* --- Register HW_PXP_S0SCALE_MX28, field RSVD2 */

#define BP_PXP_S0SCALE_MX28_RSVD2      31
#define BM_PXP_S0SCALE_MX28_RSVD2      0x80000000

#ifndef __LANGUAGE_ASM__
#define BF_PXP_S0SCALE_MX28_RSVD2(v)   ((((reg32_t) v) << 31) & BM_PXP_S0SCALE_MX28_RSVD2)
#else
#define BF_PXP_S0SCALE_MX28_RSVD2(v)   (((v) << 31) & BM_PXP_S0SCALE_MX28_RSVD2)
#endif
/* --- Register HW_PXP_S0SCALE_MX28, field YSCALE */

#define BP_PXP_S0SCALE_MX28_YSCALE      16
#define BM_PXP_S0SCALE_MX28_YSCALE      0x7FFF0000

#define BF_PXP_S0SCALE_MX28_YSCALE(v)   (((v) << 16) & BM_PXP_S0SCALE_MX28_YSCALE)
#ifndef __LANGUAGE_ASM__
#define BW_PXP_S0SCALE_MX28_YSCALE(v)   BF_CS1(PXP_S0SCALE_MX28, YSCALE, v)
#endif

/* --- Register HW_PXP_S0SCALE_MX28, field RSVD1 */

#define BP_PXP_S0SCALE_MX28_RSVD1      15
#define BM_PXP_S0SCALE_MX28_RSVD1      0x00008000

#define BF_PXP_S0SCALE_MX28_RSVD1(v)   (((v) << 15) & BM_PXP_S0SCALE_MX28_RSVD1)
/* --- Register HW_PXP_S0SCALE_MX28, field XSCALE */

#define BP_PXP_S0SCALE_MX28_XSCALE      0
#define BM_PXP_S0SCALE_MX28_XSCALE      0x00007FFF

#define BF_PXP_S0SCALE_MX28_XSCALE(v)   (((v) << 0) & BM_PXP_S0SCALE_MX28_XSCALE)
#ifndef __LANGUAGE_ASM__
#define BW_PXP_S0SCALE_MX28_XSCALE(v)   BF_CS1(PXP_S0SCALE_MX28, XSCALE, v)
#endif
