...
//------------------------------------------------------------------------------
//
//  Header:  common_lcdc.h
//
//  Provides definitions for LCDC module based on i.MX.
//
//------------------------------------------------------------------------------
#ifndef __COMMON_LCDC_H
#define __COMMON_LCDC_H
...
typedef struct {
    ...
    UINT32 CLK_POL:1;         // 0 active negatif edge, 1 active positif edge
...
//------------------------------------------------------------------------------
// SR : Size Register
#define LCDC_SR_GWLPM_LOWPOWER              1    
#define LCDC_SR_GWLPM_NORMAL                0   
