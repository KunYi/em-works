...
//
//  Screen rotation operations when not in DirectDraw Mode
//
//------------------------------------------------------------------------------
...
//
//------------------------------------------------------------------------------
int MXDDLcdc::GetRotateModeFromReg(VOID)
{
    HKEY hKey;
    int iRotate = DMDO_0;
...
//
//------------------------------------------------------------------------------
VOID MXDDLcdc::SetRotateParams(VOID)
{
    switch(m_iRotate)
    {
        case DMDO_90:
...
//
//------------------------------------------------------------------------------
LONG MXDDLcdc::DynRotate(int angle)
{
