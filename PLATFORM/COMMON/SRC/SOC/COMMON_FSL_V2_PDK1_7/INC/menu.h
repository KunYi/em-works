...
typedef struct
{
    ...
    DWORD dwPhysStart;
    DWORD dwPhysLen;
    DWORD dwNandImageStart;				// CS&ZHL MAY-23-2011: virtual start address of OS image in NandFlash
    DWORD dwNandImageLength;			// CS&ZHL MAY-23-2011: byte length of OS image in NandFlash
