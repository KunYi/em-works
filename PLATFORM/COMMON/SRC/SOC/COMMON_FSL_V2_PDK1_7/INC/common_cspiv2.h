...
//------------------------------------------------------------------------------
//
//  Header:  common_cspiv2.h
//
//  Provides definitions for CSPI (Configurable Serial Peripheral Interface)
//  module that are common to Freescale SoCs.
//
//------------------------------------------------------------------------------

#ifndef __COMMON_CSPI_H
#define __COMMON_CSPI_H
...
#define CSPI_CONREG_BITCOUNT_LSH    20
...
#define CSPI_CONREG_BITCOUNT_WID    12
