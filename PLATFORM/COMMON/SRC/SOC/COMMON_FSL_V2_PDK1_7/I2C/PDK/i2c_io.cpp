...
{    
    ...
    RETAILMSG (1, (TEXT("I2C_Init - hDev=0x%x\r\n"), pI2C));
    ...
    if (pI2C != NULL)
    {
        switch (dwCode)
        {
            ...
            case I2C_IOCTL_SET_FREQUENCY:
            {
                ...
                WORD wClkRate = pI2C->CalculateClkRateDiv(dwFreq);
...
cleanupPass1:
            ...
            case I2C_IOCTL_GET_SLAVE_TXT:
            {
                ...
                bRet = pI2C->GetSlaveText(pBufOut, dwLenOut, &dwActualOut);
                if (pdwActualOut) 
                {
