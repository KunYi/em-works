...
#include "types_phdc.h"             /* User Defined Data Types */
 ...
 *****************************************************************************/ 
/* abort apdu */
uint_8 const PHD_ABRT[ABRT_SIZE] = {
...
uint_8 const PHD_WSL_ASSOC_REQ[ASSOC_REQ_SIZE] = {   
...
uint_8 const PHD_WSL_CNFG_EVT_RPT[PHD_WSL_CNFG_EVT_RPT_SIZE] = {   
...
uint_8 const PHD_WSL_REL_REQ[REL_REQ_SIZE] = {   
...
uint_8 const PHD_WSL_REL_RES[REL_RES_SIZE] = {   
...
uint_8 const PHD_WSL_DIM_GET_RSP[PHD_WSL_DIM_GET_RSP_SIZE] = {   
0xE7, 0x00,                      /* APDU CHOICE Type (PrstApdu) */
...
#endif
#else
0x4D, 0x58, 0x32, 0x33,          // ASCII MX23
#endif
...
uint_8  const PHD_WSL_DIM_DATA_TX[PHD_WSL_DIM_DATA_TX_SIZE] = {   
0xE7, 0x00, /*APDU CHOICE Type (PrstApdu)*/
...
/* association request to send */ 
uint_8 const PHD_GLUCO_ASSOC_REQ[ASSOC_REQ_SIZE] = {   
0xE2, 0x00,                         /* APDU CHOICE Type (AarqApdu) */
0x00, 0x32,                         /* CHOICE.length = 50 */
0x80, 0x00, 0x00, 0x00,             /* assoc-version */
0x00, 0x01, 0x00, 0x2A,             /* data-proto-list.count=1 | length=42*/
...
/* configuration event report */ 
uint_8 const PHD_GLUCO_CNFG_EVT_RPT[PHD_GLUCO_CNFG_EVT_RPT_SIZE] = {   
0xE7, 0x00,                           /* APDU CHOICE Type (PrstApdu) */
0x00, 0x9A,                           /* CHOICE.length = 154 */
...
/* release request to send */
uint_8 const PHD_GLUCO_REL_REQ[REL_REQ_SIZE] = {   
0xE4, 0x00,                           /* APDU CHOICE Type (RlrqApdu) */
0x00, 0x02,                           /* CHOICE.length = 2 */
0x00, 0x00                            /* reason = normal */
};
...
/* release response to the host */
uint_8 const PHD_GLUCO_REL_RES[REL_RES_SIZE] = {   
0xE5, 0x00,                           /* APDU CHOICE Type (RlrsApdu) */
0x00, 0x02,                           /* CHOICE.length = 2 */
0x00, 0x00                            /* reason = normal */
};
...
/* response to get attributes command */
uint_8 const PHD_GLUCO_DIM_GET_RSP[PHD_GLUCO_DIM_GET_RSP_SIZE] = {   
0xE7, 0x00,                      /* APDU CHOICE Type (PrstApdu) */
0x00, 0x6E,                      /* CHOICE.length = 110 */
0x00, 0x6C,                      /* OCTET STRING.length = 108 */
0x00, 0x02,                      /* invoke-id =0x0002 (mirrored from request)*/
...
/* measurements to send */
uint_8  const PHD_GLUCO_DIM_DATA_TX[PHD_GLUCO_DIM_DATA_TX_SIZE] = {   
0xE7, 0x00, /*APDU CHOICE Type (PrstApdu)*/
...
/* association request to send */ 
uint_8 const PHD_BPM_ASSOC_REQ[ASSOC_REQ_SIZE] = {   
0xE2, 0x00,                         /* APDU CHOICE Type (AarqApdu) */
0x00, 0x32,                         /* CHOICE.length = 50 */
0x80, 0x00, 0x00, 0x00,             /* assoc-version */
0x00, 0x01, 0x00, 0x2A,             /* data-proto-list.count=1 | length=42*/
...
/* configuration event report */ 
uint_8 const PHD_BPM_CNFG_EVT_RPT[PHD_BPM_CNFG_EVT_RPT_SIZE] = {   
0xE7, 0x00,                           /* APDU CHOICE Type (PrstApdu) */
...
/* release request to send */
uint_8 const PHD_BPM_REL_REQ[REL_REQ_SIZE] = {   
0xE4, 0x00,                           /* APDU CHOICE Type (RlrqApdu) */
0x00, 0x02,                           /* CHOICE.length = 2 */
0x00, 0x00                            /* reason = normal */
};
...
/* release response to the host */
uint_8 const PHD_BPM_REL_RES[REL_RES_SIZE] = {   
0xE5, 0x00,                           /* APDU CHOICE Type (RlrsApdu) */
0x00, 0x02,                           /* CHOICE.length = 2 */
0x00, 0x00                            /* reason = normal */
};
...
/* response to get attributes command */
uint_8 const PHD_BPM_DIM_GET_RSP[PHD_BPM_DIM_GET_RSP_SIZE] = {   
0xE7, 0x00,                      /* APDU CHOICE Type (PrstApdu) */
0x00, 0x6E,                      /* CHOICE.length = 110*/
0x00, 0x6C,                      /* OCTET STRING.length = 108 */
0x00, 0x02,                      /* invoke-id =0x0002 (mirrored from request)*/
...
/* measurements to send */
uint_8  const PHD_BPM_DIM_DATA_TX[PHD_BPM_DIM_DATA_TX_SIZE] = {   
0xE7, 0x00, /*APDU CHOICE Type (PrstApdu)*/
...
/* association request to send */ 
uint_8 const PHD_THERMO_ASSOC_REQ[ASSOC_REQ_SIZE] = {   
0xE2, 0x00,                         /* APDU CHOICE Type (AarqApdu) */
0x00, 0x32,                         /* CHOICE.length = 50 */
0x80, 0x00, 0x00, 0x00,             /* assoc-version */
0x00, 0x01, 0x00, 0x2A,             /* data-proto-list.count=1 | length=42*/
...
/* configuration event report */ 
uint_8 const PHD_THERMO_CNFG_EVT_RPT[PHD_THERMO_CNFG_EVT_RPT_SIZE] = {   
0xE7, 0x00,                           /* APDU CHOICE Type (PrstApdu) */
...
/* release request to send */
uint_8 const PHD_THERMO_REL_REQ[REL_REQ_SIZE] = {   
0xE4, 0x00,                           /* APDU CHOICE Type (RlrqApdu) */
0x00, 0x02,                           /* CHOICE.length = 2 */
0x00, 0x00                            /* reason = normal */
};
...
/* release response to the host */
uint_8 const PHD_THERMO_REL_RES[REL_RES_SIZE] = {   
0xE5, 0x00,                           /* APDU CHOICE Type (RlrsApdu) */
0x00, 0x02,                           /* CHOICE.length = 2 */
0x00, 0x00                            /* reason = normal */
};
...
/* response to get attributes command */
uint_8 const PHD_THERMO_DIM_GET_RSP[PHD_THERMO_DIM_GET_RSP_SIZE] = {   
0xE7, 0x00,                      /* APDU CHOICE Type (PrstApdu) */
...
/* measurements to send */
uint_8  const PHD_THERMO_DIM_DATA_TX[PHD_THERMO_DIM_DATA_TX_SIZE] = {   
0xE7, 0x00, /*APDU CHOICE Type (PrstApdu)*/
...
)
{
    ...
    RETAILMSG(1, (L"SEND WSL MEASUREMENT\r\n"));
    *(USB_PACKET_SIZE*)size = PHD_WSL_DIM_DATA_TX_SIZE;
    /* copy the measurements to send in the phd_buffer */
    memcpy(send_buff, PHD_WSL_DIM_DATA_TX, PHD_WSL_DIM_DATA_TX_SIZE);
