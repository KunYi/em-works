...
#define ACCEPTED_UNKNOWN_CONFIG 0x300     // Endian 0x0003 -> 0x0300
...
#define ROIV_CMIP_GET_CHOSEN 0x0301   // 0x0103 ->0x0301
...
#define RORS_CMIP_CONFIRMED_EVENT_REPORT_CHOSEN 0x0102     // 0x0201 -> 0x0102
...
typedef struct _APDU
{
    intu16 choice;
    intu16 length;
#define AARQ_CHOSEN 0xE2
#define AARE_CHOSEN 0xE3
#define RLRQ_CHOSEN 0xE4
#define RLRE_CHOSEN 0xE5
#define ABRT_CHOSEN 0xE6
#define PRST_CHOSEN 0xE7        // Eric : original EX00 has different Endian, change to EX
    union
    {
        AARQ_apdu aarq;
        AARE_apdu aare;
...
typedef struct _HANDLEList
{
    intu16 count;
    intu16 length;
    HANDLE_IEEE value[1]; /* first element of the array */
} HANDLEList;
