...
#define REFTIME_50FPS 200000
#define REFTIME_60FPS 166666
...
MAKE_STREAM_MODE_RGB565(DCAM_StreamMode_RGB565_WVGA, 800, 480, 16, 30);  //WVGA
MAKE_STREAM_MODE_RGB565(DCAM_StreamMode_RGB565_PAL, 720, 576, 16, 50);  //PAL:720*576,scan line 625
MAKE_STREAM_MODE_RGB565(DCAM_StreamMode_RGB565_NTSC, 720, 480, 16, 60);  //NTSC:720*480,scan line 525
...
MAKE_STREAM_MODE_YV12(DCAM_StreamMode_YV12_WVGA, 800, -480, 12, 30);  //WVGA
MAKE_STREAM_MODE_YV12(DCAM_StreamMode_YV12_PAL, 720, -576, 12, 30);   //PAL
MAKE_STREAM_MODE_YV12(DCAM_StreamMode_YV12_NTSC, 720, -480, 12, 30);  //NTSC
