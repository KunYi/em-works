...
DWORD DDIPU::UpdateOverlay(LPDDHAL_UPDATEOVERLAYDATA pd)
{
    ...
    */
    ...
    if(pDstSurf == m_pPrimarySurface2)
    {
        ...
        overlaySurfInfo.globalAlpha = TRUE;
        ...
        {
            overlaySurfInfo.globalAlpha = FALSE;
        }
    ...
    //        while (pTempOverlay != NULL)
                ...
                ||(overlaySurfInfo.YOffset != pOverlaySurfPtr->YOffset))
        {
            ...
            SetVisibleSurfaceOverlay(pSrcSurf, NULL, TRUE);
            pd->ddRVal = DD_OK;
        }
        else
        {
...
//
//------------------------------------------------------------------------------
HRESULT DDIPU::SetVisibleSurfaceOverlay(DDGPESurf * pSurf, DDGPESurf * pSurfCurr, BOOL bWait)
{
    pOverlaySurf_t pOverlayInfo;
    UINT32 overlayIndex;
