...
BOOL IpuIntrInit(void)
{
    ...
    g_hSmfcIntrEvent = CreateEvent(NULL, FALSE, FALSE, IPU_SMFC_INTR_EVENT);
    if (g_hSmfcIntrEvent == NULL)
    {
        DEBUGMSG(ZONE_ERROR,
            (TEXT("%s: CreateEvent for SMFC Interrupt Event failed\r\n"), __WFUNCTION__));
        return ret;
    }
    ...
    g_phIntrHdlr[0][IPU_INT_IDMAC_0] = g_hSmfcIntrEvent;
    g_phIntrHdlr[0][IPU_INT_IDMAC_1] = g_hSmfcIntrEvent;
    g_phIntrHdlr[0][IPU_INT_IDMAC_2] = g_hSmfcIntrEvent;
    g_phIntrHdlr[0][IPU_INT_IDMAC_3] = g_hSmfcIntrEvent;
    ...
    g_pIntrGroupMask[0][IPU_INT_IDMAC_0] = SMFC_DMA_CHA_MASK;
    g_pIntrGroupMask[0][IPU_INT_IDMAC_1] = SMFC_DMA_CHA_MASK;
    g_pIntrGroupMask[0][IPU_INT_IDMAC_2] = SMFC_DMA_CHA_MASK;
    g_pIntrGroupMask[0][IPU_INT_IDMAC_3] = SMFC_DMA_CHA_MASK;
