    ...
    switch (dwCode)
    {
       ...
       case TVE_IOCTL_SET_CGMS_WSS_NTSC:
       {
        ...
        case   TVE_IOCTL_SET_CGMS_WSS_PAL:
        {
           ...
           pTVE->TveSetCgmsWssFor625LinePAL(pCgmsWssPAL->tveCgmsWssF1Data);
           break;
       ...
       case  TVE_IOCTL_SET_HD_CGMS_A:
       {
           TVEHDCgmsAInfo *pHDCgmaAData = (TVEHDCgmsAInfo *)pBufIn;
           if ((dwLenIn != sizeof(TVEHDCgmsAInfo)) || (pBufIn == NULL))
           {
               bRet = FALSE;
               break;
           }
           pTVE->TveSetHDCgmsAData(pHDCgmaAData->f1_data, pHDCgmaAData->f2_data);
           break;
       }

       case  TVE_IOCTL_SET_HD_CGMS_B:
       {
           TVEHDCgmsBInfo *pHDCgmaBData = (TVEHDCgmsBInfo *)pBufIn;
           if ((dwLenIn != sizeof(TVEHDCgmsBInfo)) || (pBufIn == NULL))
           {
               bRet = FALSE;
               break;
           }
           pTVE->TveSetHDCgmsBData(pHDCgmaBData);
           break;
       }
