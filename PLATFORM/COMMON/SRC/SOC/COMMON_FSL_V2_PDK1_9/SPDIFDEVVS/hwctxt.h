...
typedef struct _AUDIO_DMA_DESCRIPTOR
{
    volatile DWORD NextCmdDesc;
    volatile DWORD Command;
    volatile DWORD BufAddr;
    volatile DWORD PioWord[8-3];
} AUDIO_DMA_DESCRIPTOR, *PAUDIO_DMA_DESCRIPTOR;
