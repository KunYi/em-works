...
//
//------------------------------------------------------------------------------
#ifndef __COMMON_PXP_H__
#define __COMMON_PXP_H__
...
// IOCTL to set PXP block size info
#define PXP_IOCTL_SET_BLOCK_SIZE                21
// IOCTL to get PXP down scaling factor exponent
#define PXP_IOCTL_GET_DOWNSCALE_EXPONENT        22
//------------------------------------------------------------------------------
// Types
...
{  
    ...
    pxpS0BufferFormat_UYVY1P422,
    pxpS0BufferFormat_VYUY1P422,
    pxpS0BufferFormat_YUV2P422,
    pxpS0BufferFormat_YUV2P420,
    pxpS0BufferFormat_YVU2P422,
    pxpS0BufferFormat_YVU2P420
} pxpS0BufferFormat;
...
typedef enum pxpOutputFormatEnum
{  
    ...
    pxpOutputFormat_YUV444 = 7,
    pxpOutputFormat_UYVY1P422 = 0xA,
    pxpOutputFormat_VYUY1P422,
    pxpOutputFormat_YUV2P422,
    pxpOutputFormat_YUV2P420,
    pxpOutputFormat_YVU2P422,
    pxpOutputFormat_YVU2P420
} pxpOutputFormat;
...
BOOL PXPSetBlockSize(HANDLE hPXP, UINT32 *pBlockSize);
BOOL PXPGetDownScaleFactorExponent(HANDLE hPXP, UINT32 *pDownScaleExp);
//#ifdef __cplusplus
//}
//#endif

#endif   // __COMMON_PXP_H__
