...
//  File:  ecspiclass.h
//
//   Header file for ecspi bus driver.
//
//------------------------------------------------------------------------------
#ifndef __ECSPICLASS_H__
#define __ECSPICLASS_H__
...
public:
    ...
    BOOL m_bExchanging;        //for D0 powerstate 
    BOOL m_bUsePolling;
