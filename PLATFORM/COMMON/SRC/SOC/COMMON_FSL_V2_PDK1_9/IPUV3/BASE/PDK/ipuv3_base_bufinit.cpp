...
BOOL IpuBufferManagerInit(BOOL bCachedWT)
{
    ...
    if (bCachedWT)
    {
        ...
        //                       0x008                   0x1CC
        //
        VirtualSetAttributes((PUCHAR)g_pVideoMemory, g_nVideoMemorySize, 0x8, 0x1CC, NULL);
    }
    else
    {
        ...
        //                       0x040                   0x1CC
        //
        VirtualSetAttributes((PUCHAR)g_pVideoMemory, g_nVideoMemorySize, 0x40, 0x1CC, NULL);
    }
    ...
    if (bCachedWT)
    {
        ...
        //                       0x008                   0x1CC
        //
        VirtualSetAttributes((PUCHAR)g_pIRAM, g_nIRAMSize, 0x8, 0x1CC, NULL);
    }
    else
    {
        // Update the Framebuffer to be non-cached, bufferable
        ...
        //                       0x040                   0x1CC
        //
        VirtualSetAttributes((PUCHAR)g_pIRAM, g_nIRAMSize, 0x40, 0x1CC, NULL);
    }
