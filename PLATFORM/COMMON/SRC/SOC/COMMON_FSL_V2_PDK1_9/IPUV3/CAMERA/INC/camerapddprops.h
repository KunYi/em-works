...
static const WCHAR g_wszPin1DeviceNames[MAX_SUPPORTED_PINS][MAX_PINNAME_LENGTH] = {L"PIN1:",
                                                                                   L"PIN1:",
                                                                                   L"PIN1:"};

static const WCHAR g_wszPin2DeviceNames[MAX_SUPPORTED_PINS][MAX_PINNAME_LENGTH] = {L"PIN2:",
                                                                                   L"PIN2:",
                                                                                   L"PIN2:"};
