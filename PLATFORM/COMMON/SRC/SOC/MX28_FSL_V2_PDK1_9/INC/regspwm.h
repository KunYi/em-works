...
//
//  Header: regspwm.h
//  PIO Registers for PWM interface
//------------------------------------------------------------------------------
...
#define REGS_PWM_BASE (DWORD)pv_HWRegPWM
...
#define BP_PWM_CTRL_PWM2_ANA_CTRL_ENABLE      8
#define BM_PWM_CTRL_PWM2_ANA_CTRL_ENABLE      0x00000100

#define BF_PWM_CTRL_PWM2_ANA_CTRL_ENABLE(v)   (((v) << 8) & BM_PWM_CTRL_PWM2_ANA_CTRL_ENABLE)
#ifndef __LANGUAGE_ASM__
