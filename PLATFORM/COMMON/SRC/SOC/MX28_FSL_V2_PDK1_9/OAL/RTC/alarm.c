...
//  Module: alarm.c
//
//  Real-time clock (RTC) routines for the Freescale i.MX28 processor
//
//------------------------------------------------------------------------------
...
BOOL OALRTC_SetAlarmMode( RtcAlarmMode_t mode )
{
    ...
    {
        OALMSG(OAL_ERROR, (L"ERROR: OALRTC_SetAlarmMode: Invalid Alarm Mode\r\n"));
        goto CleanUp;
    }
