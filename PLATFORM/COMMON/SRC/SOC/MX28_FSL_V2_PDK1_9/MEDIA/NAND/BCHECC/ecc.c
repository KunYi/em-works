...
{
    RETAILMSG(TRUE, (_T("NAND_ECCConfLayout, pagesize=%d,sparesize=%d\r\n"),PageSize,SpareSize));
    ...
    else if(PageSize == 4096 && SpareSize == 128)
    {
        HW_BCH_FLASH0LAYOUT0_WR(BF_BCH_FLASH0LAYOUT0_NBLOCKS(0x8) | BF_BCH_FLASH0LAYOUT0_META_SIZE(METADATA_SIZE) | BF_BCH_FLASH0LAYOUT0_ECC0(ECC0_2K4K_PAGE));
        HW_BCH_FLASH0LAYOUT1_WR(BF_BCH_FLASH0LAYOUT1_PAGE_SIZE(4096+128) | BF_BCH_FLASH0LAYOUT1_ECCN(ECCN_4K128_PAGE) | BF_BCH_FLASH0LAYOUT1_DATAN_SIZE(512));
    }
    else if(PageSize == 4096 && SpareSize == 218)
    {
        HW_BCH_FLASH0LAYOUT0_WR(BF_BCH_FLASH0LAYOUT0_NBLOCKS(0x8) | BF_BCH_FLASH0LAYOUT0_META_SIZE(METADATA_SIZE) | BF_BCH_FLASH0LAYOUT0_ECC0(ECC0_2K4K_PAGE));
        HW_BCH_FLASH0LAYOUT1_WR(BF_BCH_FLASH0LAYOUT1_PAGE_SIZE(4096+218) | BF_BCH_FLASH0LAYOUT1_ECCN(ECCN_4K218_PAGE) | BF_BCH_FLASH0LAYOUT1_DATAN_SIZE(512));
    }
