...
void OALGpioSpiEnable(DWORD dwCSNum)
{
	...
	{
	case 0:
		HW_PINCTRL_DOUT0_SET(0x10200000);	// GPIO0_21 = GPIO0_28 = 1
		HW_PINCTRL_DOUT0_CLR(1 << 17);		// GPIO0_17 = 0;
		break;

	case 1:
		HW_PINCTRL_DOUT0_SET(0x10020000);	// GPIO0_17 = GPIO0_28 = 1
		HW_PINCTRL_DOUT0_CLR(1 << 21);		// GPIO0_21 = 0;
		break;

	case 2:
		HW_PINCTRL_DOUT0_SET(0x00220000);	// GPIO0_17 = GPIO0_21 = 1
...
BOOL OALSPI_Access(VOID* pInpBuffer, UINT32 inpSize)
{
	...
	case SPI_ACCESS_CODE_WRITEBYTE:
		OALGpioSpiWrite(pInfo->dwCSNum, pInfo->dwStartAddr, pInfo->pDataBuf[0]);
		bRet = TRUE;
		break;
