...
//------------------------------------------------------------------------------
//
//  Header:  common_avic.h
//
//  Provides definitions for the AVIC (ARM Vectored Interrupt Controller) 
//  module that are common to Freescale SoCs.
//
//------------------------------------------------------------------------------
#ifndef __COMMON_AVIC_H
#define __COMMON_AVIC_H
