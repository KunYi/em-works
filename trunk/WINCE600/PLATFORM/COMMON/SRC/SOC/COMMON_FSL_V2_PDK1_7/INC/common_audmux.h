...
//------------------------------------------------------------------------------
//
//  Header:  common_audmux.h
//
//  Provides definitions for the AUDMUX (Digital Audio Mux) module that are
//  common to Freescale SoCs.
//
//------------------------------------------------------------------------------
#ifndef __COMMON_AUDMUX_H
#define __COMMON_AUDMUX_H
