...
//------------------------------------------------------------------------------
//
// Header: common_rngc.h
//
// Provides definitions for RNGC module.
//
//------------------------------------------------------------------------------
#ifndef __COMMON_RNGC_H
#define __COMMON_RNGC_H
...
#define RNG_ERROR_SR_RAND_LSH       5
#define RNG_ERROR_SR_PARITY_LSH     6
...
#define RNG_ERROR_SR_RAND_WID       1
#define RNG_ERROR_SR_PARITY_WID     1
