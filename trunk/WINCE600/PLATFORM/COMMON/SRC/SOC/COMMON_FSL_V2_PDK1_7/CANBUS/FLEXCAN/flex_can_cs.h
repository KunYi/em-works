...
#define CAN_CTRL_BIT_TIMING_500KHZ			0x01790003
#define CAN_CTRL_BIT_TIMING_250KHZ			0x02790004
#define CAN_CTRL_BIT_TIMING_125KHZ			0x05790004
...
#define CAN_IOCTL_WAIT_DATA_ARRIVE		CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3812, METHOD_BUFFERED, FILE_ANY_ACCESS) 
