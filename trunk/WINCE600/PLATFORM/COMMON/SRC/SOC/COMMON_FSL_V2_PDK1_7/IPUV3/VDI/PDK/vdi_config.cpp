...
BOOL VDIInit(void)
{
    ...
    VDISetWatermarkLevel(VDI_CHANNEL_1, IPU_VDI_C_WATERMARK_FIFO_2_8TH);
    ...
    VDIClearWatermarkLevel(VDI_CHANNEL_3, IPU_VDI_C_WATERMARK_FIFO_1_8TH);
...
void VDIIDMACChannelConfig(pVdiConfigData pConfigData)
{
    ...
    VDISetBurstSize(VDI_CHANNEL_1, (CPMEMData.iPixelBurst+1)/4-1);
    VDISetBurstSize(VDI_CHANNEL_2, (CPMEMData.iPixelBurst+1)/4-1);
    VDISetBurstSize(VDI_CHANNEL_3, (CPMEMData.iPixelBurst+1)/4-1);
