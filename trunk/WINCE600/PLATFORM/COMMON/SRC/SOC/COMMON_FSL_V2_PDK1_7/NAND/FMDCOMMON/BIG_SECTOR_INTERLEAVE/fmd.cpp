...
{
	//
	// CS&ZHL MAY-16-2011: we don't want to support IoControl in case of multi-partition disk
	// 
#ifdef	NAND_PDD
...
DWORD FMD_GetBlockStatus(BLOCK_ID blockID)
{
	...
	//
	// CS&ZHL MAY-14-2011: reserve the first 36MB for boot
	//
	//{
	//	DWORD dwStartBlockNum;
	//	
	//	dwStartBlockNum = IMAGE_BOOT_NANDDEV_RESERVED_SIZE / ((DWORD)g_FlashInfoExt.fi.wDataBytesPerSector * g_FlashInfoExt.fi.wSectorsPerBlock);
	//	if(blockID < dwStartBlockNum)
	//	{
