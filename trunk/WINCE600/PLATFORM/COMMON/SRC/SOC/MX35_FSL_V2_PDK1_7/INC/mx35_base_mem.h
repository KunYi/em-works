...
//------------------------------------------------------------------------------
//
//  Header: mx35_base_mem.h
//
//  This header file defines the Physical Addresses (PA) of
//  the SoC chip selects and external memory assignments.
//
//  Provides memory map definitions specific to the MX35 SoC.
//
//------------------------------------------------------------------------------
#ifndef __MX35_BASE_MEM_H
#define __MX35_BASE_MEM_H
...
//-----------------------------------------------------------------------------
// MX35-SPECIFIC INTERNAL MEMORY MAP
//-----------------------------------------------------------------------------
#define CSP_BASE_MEM_PA_SECURE_IROM             (0x00000000)
#define CSP_BASE_MEM_PA_IROM                    (0x00404000)
#define CSP_BASE_MEM_PA_IRAM                    (0x10000000)
#define CSP_BASE_MEM_PA_AIPS1                   (0x40000000)
#define CSP_BASE_MEM_PA_AIPS2                   (0x50000000)

//-----------------------------------------------------------------------------
// MX35-SPECIFIC EXTERNAL MEMORY MAP
//-----------------------------------------------------------------------------
