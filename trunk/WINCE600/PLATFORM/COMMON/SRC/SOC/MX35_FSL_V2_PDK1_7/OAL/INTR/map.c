...
//  SYSINTR. This is custom implementation for MX35 because there can be
//  additional 32x3 GPIO IRQs and 32 SDMA IRQs. These 128 secondary interrupts 
//  generate hardware interrupts IRQ_GPIO1, IRQ_GPIO2, IRQ_GPIO3 and IRQ_SDMA 
