...
//  File: registry.c
//
//  This file contains the functions necessary to read the data from the registry.
...
//
// Description: Read a string from the corresponding registry with a given key 
//             (pParam->pName)
//
// Parameter:
//     hKey
...
//     pBase
//         [IN/OUT] Pointers to PDD context, it also store the output value 
//                  into its offset depending on the pParam
//     pParam
//         [IN] Pointers to a table contanting DEVICE_REGISTRY_PARAM structure
//
// Return:
//
...
//    [IN/OUT] pBase - pointer to PDD context, it also store the output value into its offset
//                     depending on the pParam
