...
BOOL NFCSetPagesize(UINT32 PageSize)
{
    ...
    // Map peripheral physical address to virtual address
    pCRM = (PCSP_CRM_REGS)BSPNAND_RemapRegister(CSP_BASE_REG_PA_CRM, sizeof(CSP_CRM_REGS));
    ...
    case 4096:
        ...
        INSREG32BF(&pCRM->RCSR, CRM_RCSR_NFC_FMS, CRM_RCSR_NFC_FMS_NOT2K);
        INSREG32BF(&pCRM->RCSR, CRM_RCSR_NFC_4K, CRM_RCSR_NFC_4K_4K);
        break;
       
    case 2048:
        // 2KB NAND Flash Page Size
        INSREG32BF(&pCRM->RCSR, CRM_RCSR_NFC_FMS, CRM_RCSR_NFC_FMS_2K);
        INSREG32BF(&pCRM->RCSR, CRM_RCSR_NFC_4K, CRM_RCSR_NFC_4K_NOT4K);
        break;
