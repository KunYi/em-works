...
typedef enum {
  ...
  #define _NAME_TOUCH_EVENT                             _T("STMP37XX_TouchEvent")
  #define _NAME_KEYPAD_EVENT                    _T("STMP37XX_KeyPadEvent")
  #define _NAME_BATTERY_EVENT                   _T("STMP37XX_BatteryEvent")
...
BOOL LRADCGetClkGate(HANDLE hLRADC); BOOL LRADCGetTouchDetectPresent(HANDLE hLRADC);
