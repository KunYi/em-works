...
//
//  Header: regstvenc.h
//  PIO Registers for TVENC interface
//------------------------------------------------------------------------------
...
#define HW_TVENC_RESERVE0_ADDR      (REGS_TVENC_BASE + 0x00000150)
#define HW_TVENC_RESERVE0_SET_ADDR  (REGS_TVENC_BASE + 0x00000154)
#define HW_TVENC_RESERVE0_CLR_ADDR  (REGS_TVENC_BASE + 0x00000158)
#define HW_TVENC_RESERVE0_TOG_ADDR  (REGS_TVENC_BASE + 0x0000015C)

#ifndef __LANGUAGE_ASM__
#define HW_TVENC_RESERVE0           (*(volatile hw_tvenc_reseve0_t *) HW_TVENC_RESERVE0_ADDR)
#define HW_TVENC_RESERVE0_RD()      (HW_TVENC_RESERVE0.U)
#define HW_TVENC_RESERVE0_WR(v)     (HW_TVENC_RESERVE0.U = (v))
#define HW_TVENC_RESERVE0_SET(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE0_SET_ADDR) = (v))
#define HW_TVENC_RESERVE0_CLR(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE0_CLR_ADDR) = (v))
#define HW_TVENC_RESERVE0_TOG(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE0_TOG_ADDR) = (v))
#endif



#define BP_TVENC_RESERVE0_DATA      0
#define BM_TVENC_RESERVE0_DATA      0xFFFFFFFF

#ifndef __LANGUAGE_ASM__
#define BF_TVENC_RESERVE0_DATA(v)   ((reg32_t) v)
#else
#define BF_TVENC_RESERVE0_DATA(v)   (v)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_RESERVE0_DATA(v)   (HW_TVENC_RESERVE0.B.DATA = (v))
#endif
...
#define HW_TVENC_RESERVE1_ADDR      (REGS_TVENC_BASE + 0x00000160)
#define HW_TVENC_RESERVE1_SET_ADDR  (REGS_TVENC_BASE + 0x00000164)
#define HW_TVENC_RESERVE1_CLR_ADDR  (REGS_TVENC_BASE + 0x00000168)
#define HW_TVENC_RESERVE1_TOG_ADDR  (REGS_TVENC_BASE + 0x0000016C)

#ifndef __LANGUAGE_ASM__
#define HW_TVENC_RESERVE1           (*(volatile hw_tvenc_reseve1_t *) HW_TVENC_RESERVE1_ADDR)
#define HW_TVENC_RESERVE1_RD()      (HW_TVENC_RESERVE1.U)
#define HW_TVENC_RESERVE1_WR(v)     (HW_TVENC_RESERVE1.U = (v))
#define HW_TVENC_RESERVE1_SET(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE1_SET_ADDR) = (v))
#define HW_TVENC_RESERVE1_CLR(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE1_CLR_ADDR) = (v))
#define HW_TVENC_RESERVE1_TOG(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE1_TOG_ADDR) = (v))
#endif



#define BP_TVENC_RESERVE1_DATA      0
#define BM_TVENC_RESERVE1_DATA      0xFFFFFFFF

#ifndef __LANGUAGE_ASM__
#define BF_TVENC_RESERVE1_DATA(v)   ((reg32_t) v)
#else
#define BF_TVENC_RESERVE1_DATA(v)   (v)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_RESERVE1_DATA(v)   (HW_TVENC_RESERVE1.B.DATA = (v))
#endif
...
#define HW_TVENC_RESERVE2_ADDR      (REGS_TVENC_BASE + 0x00000170)
#define HW_TVENC_RESERVE2_SET_ADDR  (REGS_TVENC_BASE + 0x00000174)
#define HW_TVENC_RESERVE2_CLR_ADDR  (REGS_TVENC_BASE + 0x00000178)
#define HW_TVENC_RESERVE2_TOG_ADDR  (REGS_TVENC_BASE + 0x0000017C)

#ifndef __LANGUAGE_ASM__
#define HW_TVENC_RESERVE2           (*(volatile hw_tvenc_reseve2_t *) HW_TVENC_RESERVE2_ADDR)
#define HW_TVENC_RESERVE2_RD()      (HW_TVENC_RESERVE2.U)
#define HW_TVENC_RESERVE2_WR(v)     (HW_TVENC_RESERVE2.U = (v))
#define HW_TVENC_RESERVE2_SET(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE2_SET_ADDR) = (v))
#define HW_TVENC_RESERVE2_CLR(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE2_CLR_ADDR) = (v))
#define HW_TVENC_RESERVE2_TOG(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE2_TOG_ADDR) = (v))
#endif



#define BP_TVENC_RESERVE2_DATA      0
#define BM_TVENC_RESERVE2_DATA      0xFFFFFFFF

#ifndef __LANGUAGE_ASM__
#define BF_TVENC_RESERVE2_DATA(v)   ((reg32_t) v)
#else
#define BF_TVENC_RESERVE2_DATA(v)   (v)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_RESERVE2_DATA(v)   (HW_TVENC_RESERVE2.B.DATA = (v))
#endif
...
#define HW_TVENC_RESERVE3_ADDR      (REGS_TVENC_BASE + 0x00000180)
#define HW_TVENC_RESERVE3_SET_ADDR  (REGS_TVENC_BASE + 0x00000184)
#define HW_TVENC_RESERVE3_CLR_ADDR  (REGS_TVENC_BASE + 0x00000188)
#define HW_TVENC_RESERVE3_TOG_ADDR  (REGS_TVENC_BASE + 0x0000018C)

#ifndef __LANGUAGE_ASM__
#define HW_TVENC_RESERVE3           (*(volatile hw_tvenc_reseve3_t *) HW_TVENC_RESERVE3_ADDR)
#define HW_TVENC_RESERVE3_RD()      (HW_TVENC_RESERVE3.U)
#define HW_TVENC_RESERVE3_WR(v)     (HW_TVENC_RESERVE3.U = (v))
#define HW_TVENC_RESERVE3_SET(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE3_SET_ADDR) = (v))
#define HW_TVENC_RESERVE3_CLR(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE3_CLR_ADDR) = (v))
#define HW_TVENC_RESERVE3_TOG(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE3_TOG_ADDR) = (v))
#endif


#define BP_TVENC_RESERVE3_DATA      0
#define BM_TVENC_RESERVE3_DATA      0xFFFFFFFF

#ifndef __LANGUAGE_ASM__
#define BF_TVENC_RESERVE3_DATA(v)   ((reg32_t) v)
#else
#define BF_TVENC_RESERVE3_DATA(v)   (v)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_RESERVE3_DATA(v)   (HW_TVENC_RESERVE3.B.DATA = (v))
#endif
...
#define HW_TVENC_RESERVE4_ADDR      (REGS_TVENC_BASE + 0x00000190)
#define HW_TVENC_RESERVE4_SET_ADDR  (REGS_TVENC_BASE + 0x00000194)
#define HW_TVENC_RESERVE4_CLR_ADDR  (REGS_TVENC_BASE + 0x00000198)
#define HW_TVENC_RESERVE4_TOG_ADDR  (REGS_TVENC_BASE + 0x0000019C)

#ifndef __LANGUAGE_ASM__
#define HW_TVENC_RESERVE4           (*(volatile hw_tvenc_reseve4_t *) HW_TVENC_RESERVE4_ADDR)
#define HW_TVENC_RESERVE4_RD()      (HW_TVENC_RESERVE4.U)
#define HW_TVENC_RESERVE4_WR(v)     (HW_TVENC_RESERVE4.U = (v))
#define HW_TVENC_RESERVE4_SET(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE4_SET_ADDR) = (v))
#define HW_TVENC_RESERVE4_CLR(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE4_CLR_ADDR) = (v))
#define HW_TVENC_RESERVE4_TOG(v)    ((*(volatile reg32_t *) HW_TVENC_RESERVE4_TOG_ADDR) = (v))
#endif


#define BP_TVENC_RESERVE4_DATA      0
#define BM_TVENC_RESERVE4_DATA      0x000007FF

#define BF_TVENC_RESERVE4_DATA(v)   (((v) << 0) & BM_TVENC_RESERVE4_DATA)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_RESERVE4_DATA(v)   BF_CS1(TVENC_RESERVE4, DATA, v)
#endif
...
typedef struct
{
    volatile hw_tvenc_ctrl_t           ctrl          ;UINT32 _reserved0[3]; // 000
    volatile hw_tvenc_config_t         config        ;UINT32 _reserved1[3]; // 010
    volatile hw_tvenc_filtctrl_t       filtctrl      ;UINT32 _reserved2[3]; // 020
    volatile hw_tvenc_syncoffset_t     syncoffset    ;UINT32 _reserved3[3]; // 030
    volatile hw_tvenc_htimingsync0_t   htimingsync0  ;UINT32 _reserved4[3]; // 040
    volatile hw_tvenc_htimingsync1_t   htimingsync1  ;UINT32 _reserved5[3]; // 050
    volatile hw_tvenc_htimingactive_t  htimingactive ;UINT32 _reserved6[3]; // 060
    volatile hw_tvenc_htimingburst0_t  htimingburst0 ;UINT32 _reserved7[3]; // 070
    volatile hw_tvenc_htimingburst1_t  htimingburst1 ;UINT32 _reserved8[3]; // 080
    volatile hw_tvenc_vtiming0_t       vtiming0      ;UINT32 _reserved9[3]; // 090
    volatile hw_tvenc_vtiming1_t       vtiming1      ;UINT32 _reserved10[3];// 0a0
    volatile hw_tvenc_misc_t           misc          ;UINT32 _reserved11[3];// 0b0
    volatile hw_tvenc_colorsub0_t      colorsub0     ;UINT32 _reserved12[3];// 0c0
    volatile hw_tvenc_colorsub1_t      colorsub1     ;UINT32 _reserved13[3];// 0d0
    volatile hw_tvenc_copyprotect_t    copyprotect   ;UINT32 _reserved14[3];// 0e0
    volatile hw_tvenc_closedcaption_t  closedcaption ;UINT32 _reserved15[3];// 0f0
                                                      UINT32 _reserved16[16];//100
    volatile hw_tvenc_colorburst_t     colorburst    ;UINT32 _reserved17[3];// 140
    volatile hw_tvenc_reseve0_t        reseve0       ;UINT32 _reserved18[3];// 150
    volatile hw_tvenc_reseve1_t        reseve1       ;UINT32 _reserved19[3];// 160
    volatile hw_tvenc_reseve2_t        reseve2       ;UINT32 _reserved20[3];// 170
    volatile hw_tvenc_reseve3_t        reseve3       ;UINT32 _reserved21[3];// 180
    volatile hw_tvenc_reseve4_t        reseve4       ;UINT32 _reserved22[3];// 190
    volatile hw_tvenc_dacctrl_t        dacctrl       ;UINT32 _reserved23[3];// 1a0
    volatile hw_tvenc_dacstatus_t      dacstatus     ;UINT32 _reserved24[3];// 1b0
    volatile hw_tvenc_vdactest_t       vdactest      ;UINT32 _reserved25[3];// 1c0
    volatile hw_tvenc_version_t        version       ;UINT32 _reserved26[3];// 1d0
} CSP_TVENC_REG, *PCSP_TVENC_REG;
