...
//------------------------------------------------------------------------------
//
//  Header:  MX233_nandlayout.h
//
//  Provides definitions for NAND layout on Freescale MX233 SoC.
//
//------------------------------------------------------------------------------
#ifndef __MX233_NANDLAYOUT_H
#define __MX233_NANDLAYOUT_H
...
#define CHIP_LDLB_NAND_OFFSET         (CHIP_NCB_NAND_OFFSET + CHIP_NCB_NAND_BLOCKS)
#define CHIP_LDLB_NAND_BLOCKS         (2 * CHIP_BCB_BLOCK_LIMIT)
