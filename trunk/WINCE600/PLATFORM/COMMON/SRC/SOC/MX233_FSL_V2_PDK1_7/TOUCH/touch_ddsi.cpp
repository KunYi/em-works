...
DWORD gtouchint=IRQ_TOUCH_DETECT;
DWORD gtouchCangedIrq=IRQ_LRADC_CH3;
...
extern "C" LONG DdsiTouchPanelDetach()
{
    ...
    gIntrTouchChanged = (DWORD)SYSINTR_UNDEFINED;
...
extern "C" void DdsiTouchPanelGetPoint(TOUCH_PANEL_SAMPLE_FLAGS *pTipStateFlags, INT *pUncalX, INT *pUncalY)
{
    ...
    *pTipStateFlags = TouchSampleValidFlag;
    ...
    if(*pTipStateFlags == TouchSampleValidFlag) //0x01
    {
        // Enable Touch detect
