...
//------------------------------------------------------------------------------
// Defines
#define SPI_IOCTL_EXCHANGE             CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3030, METHOD_BUFFERED, FILE_ANY_ACCESS)  
#define SPI_IOCTL_ENABLE_LOOPBACK      CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3031, METHOD_BUFFERED, FILE_ANY_ACCESS)  
#define SPI_IOCTL_DISABLE_LOOPBACK     CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3032, METHOD_BUFFERED, FILE_ANY_ACCESS)  
#define SPI_IOCTL_SSPCONFIGURE         CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3033, METHOD_BUFFERED, FILE_ANY_ACCESS)    
#define SPI_IOCTL_SSPRESETAFTERERROR   CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3034, METHOD_BUFFERED, FILE_ANY_ACCESS)    
#define SPI_IOCTL_SSPCHECKERRORS       CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3035, METHOD_BUFFERED, FILE_ANY_ACCESS)    
#define SPI_IOCTL_SSPGETIRQSTATUS      CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3036, METHOD_BUFFERED, FILE_ANY_ACCESS)    
#define SPI_IOCTL_SSPCLEARIRQ          CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3037, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define SPI_IOCTL_SSPCONFIGTIMING      CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3038, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define SPI_IOCTL_SSP_EN_ERROR         CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3039, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define SPI_IOCTL_SSP_DIS_ERROR        CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3040, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define SPI_IOCTL_SSP_CLR_LOCK_CS      CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3041, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define SPI_IOCTL_SSP_CLR_DET          CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3042, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define SPI_IOCTL_SSP_GET_RESP         CTL_CODE(FILE_DEVICE_BUS_EXTENDER, 3043, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define SPI_MAXENQ_EVENT_NAME        64
//------------------------------------------------------------------------------
// Types
...
typedef struct 
{
    ...
    BOOL      bRead;
    BOOL      bCmd;
} SPI_BUSCONFIG_T, *PSPI_BUSCONFIG_T;
...
BOOL SPIClearLOCKCS(HANDLE hSPI);
