...
//  File:  cspecspi.c
//
//  Provides SoC-specific configuration routines for the eCSPIBUS.
//
//-----------------------------------------------------------------------------
...
DWORD CspCSPIGetBaseRegAddr(UINT32 index)
{
    ...
    {
        case 1:
            return CSP_BASE_REG_PA_ECSPI1;
        case 2:
            return CSP_BASE_REG_PA_ECSPI2;
        default:
            return 0;
    }
}
...
//
//------------------------------------------------------------------------------
BOOL CspCheckPort(UINT32 Index)
{
    if( CSPI_LAN_Index==Index )
    {
        return TRUE;
    }
