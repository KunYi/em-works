...
static SourceDeviceClocks_t _MCBSP1_SourceClock = {1, {kCORE_96M_FCLK}};
static SourceDeviceClocks_t _MCBSP2_SourceClock = {1, {k96M_ALWON_FCLK}};
static SourceDeviceClocks_t _MCBSP3_SourceClock = {1, {k96M_ALWON_FCLK}};
static SourceDeviceClocks_t _MCBSP4_SourceClock = {1, {k96M_ALWON_FCLK}};
static SourceDeviceClocks_t _MCBSP5_SourceClock = {1, {kCORE_96M_FCLK}};
...
FCLK_DECL(_fclk_DSS1, 0, CM_CLKEN_DSS2, cm_offset(CM_FCLKEN_xxx));
FCLK_DECL(_fclk_DSS2, 0, CM_CLKEN_DSS1, cm_offset(CM_FCLKEN_xxx));
