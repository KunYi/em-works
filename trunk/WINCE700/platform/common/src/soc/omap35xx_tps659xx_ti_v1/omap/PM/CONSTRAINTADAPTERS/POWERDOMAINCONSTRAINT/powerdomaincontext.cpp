    ...
    )
{
    ...
    // mpu
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_MPU);
    ...
    // core
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_CORE);
    ...
    // iva
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_IVA);
    ...
    // usbhost
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_USBHOST);
    ...
    // dss
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_DSS);
    ...
    // sgx
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_SGX);
    ...
    // peripheral
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_PERIPHERAL);
    ...
    // camera
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_CAMERA);
    ...
    // neon
    _stprintf_s(szBuffer,_countof(szBuffer), REGEDIT_POWERDOMAIN_FMT, szContext, REGEDIT_POWERDOMAIN_NEON);
