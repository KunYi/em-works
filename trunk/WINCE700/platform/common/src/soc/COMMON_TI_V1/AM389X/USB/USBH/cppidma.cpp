...
CCppiDmaRxChannel::~CCppiDmaRxChannel()
{
    ...
    USBCDMA_ConfigureScheduleRx(m_chNum, FALSE); // Disable Rx for this channel in the DMA scheduler
    ...
    UINT32 nOptions, PVOID pCookie1, PVOID pCookie2)
{
    ...
    DEBUGMSG(CPPI_DBG_RX, (L" CCppiDmaTxChannel::IssueTransfer: RndisMode %d, epMaxPkt %u, MaxBD %u\r\n",
         fIsRndisMode, m_epMaxPkt, m_nMaxBD));
...
void CCppiDmaController::OnCompletionEvent()
{
	...
	while ((pending1 & USB_CPPI_PEND1_QMSK_HOST) || (pending2 & USB_CPPI_PEND2_QMSK_HOST) ) {
