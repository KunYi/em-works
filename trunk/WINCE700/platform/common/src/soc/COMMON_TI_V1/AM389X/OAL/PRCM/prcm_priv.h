...
typedef struct {
    ...
    LONG			CLKCTRL_REG; // offset to the register on the AM389X_PRCM_REGS struct
} DeviceLookupEntry;
...
typedef struct {
	...
	LONG			CLKSTCTRL_REG;// offset to the register on the AM389X_PRCM_REGS struct
...
extern AM389X_PRCM_REGS    *g_pPrcmRegs;
