...
// Original arbitrarily fixed values defined for OMAP:
//   EXT_MMCHS_STAT_CD_INSERT_INTR=0x80000000
//   EXT_MMCHS_STAT_CD_REMOVE_INTR=0x40000000
// 
// But Netra requires 0x00000040 and 0x00000080
// So no harm to change to 0x00000040 and 0x00000080 respectively.
...
public:
    ...
    // SetCDPolarity is used by OMAP but not Netra.
    // For OMAP, it is a one liner: OUTREG32(&m_pbRegisters->MMCHS_CON, 0x01 << 7);
    // For Netra, it is a stub.
    virtual VOID    SetCDPolarity() = 0;
...
public:
    ...
    HANDLE               m_hGPIO;                       // GPIO driver handle; NOT used in AM389X
    ...
    //The following 4 GPIO related vars are not applicable to AM389X
