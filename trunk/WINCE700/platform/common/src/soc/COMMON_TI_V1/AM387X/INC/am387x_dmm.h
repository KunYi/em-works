...
#ifndef __AM387X_DMM_H
#define __AM387X_DMM_H
...
typedef volatile struct {
	...
	UINT32	RES_0030_00C4[38];		// 
	UINT32	SDRAM_ZQCR;             // 0x00C8
	UINT32	RES_00CC_00D4[3];		// 

    REG32	RDWR_LVL_RMP_CTRL;		// 0x00D8
    REG32	RDWR_LVL_CTRL;			// 0x00DC
	UINT32	RES_00E0;				// 
