...
static MEMORY_REGISTER_ENTRY _pRegEntries[] = {
	...
	{0x48000000,  0x0300000, NULL }, // Slow Periferal domain L4
	{0x4A000000,  0x0200000, NULL }, // Fast Periferal domain L4
	{0x47C00000,  0x0400000, NULL }, // L4 Firewall Pripheral
	{0x40300000,  0x0100000, NULL }, // OCMC SRAM
	...
	{0x8A200000,  0x4E00000, NULL }, // 78MB for Display. Syslink shared mem, M3 code/data
	{0xA0000000,  0x0400000, NULL }, // 4MB for Display. VPSS shared mem, vpdma desc mem
	{0,           0,         NULL }
};
