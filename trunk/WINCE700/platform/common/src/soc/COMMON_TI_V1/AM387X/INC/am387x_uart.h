...
#ifndef __AM387X_UART_H
#define __AM387X_UART_H
...
typedef volatile struct {
   ...
   UINT8 RESERVED_24[3];
	...
	UINT8 RXFIFO_LVL;				// offset 0x64
	UINT8 RESERVED_25[3];
	
	UINT8 TXFIFO_LVL;				// offset 0x68
	UINT8 RESERVED_26[3];

	UINT8 IER2;						// offset 0x6C
	UINT8 RESERVED_27[3];

	UINT8 ISR2;						// offset 0x70
	UINT8 RESERVED_28[3];

	UINT8 FREQ_SEL;					// offset 0x74
	UINT8 RESERVED_29[11];

	UINT8 MDR3;						// offset 0x80
	UINT8 RESERVED_30[3];

	UINT8 TDT;						// offset 0x84
	UINT8 RESERVED_31[3];
