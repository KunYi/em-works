...
trySystemMem:
    ...
    *ppSurf = new GPESurf(width, height, format);
    if (*ppSurf != NULL)
    {
        ...
        {
            DEBUGMSG(GPE_ZONE_VIDEOMEMORY, (TEXT("OMAPDDGPE::AllocSurface  Used System memory for Width=%d, Height=%d, numPixels=%d, format=%d\r\n"), width, height, width*height, format));
            return S_OK;
        }
    }
...
{
    RETAILMSG(1, (L"OMAPDDGPE::FlipInProgress called\r\n"));
...
{  
//    RETAILMSG(1, (L"OMAPDDGPE::WaitForVBlank called\r\n"));
...
//    RETAILMSG(1, (L"OMAPDDGPE::SurfaceFlipping called\r\n"));
    ...
    )
{
    ...
    DEBUGMSG(1, (L"OMAPDDGPE::FlipSurface called. pSurf=0x%x, pSurf->OmapSurface()=0x%x, m_pPrimarySurf=0x%x\r\n",pSurf, pSurf->OmapSurface(), m_pPrimarySurf));
