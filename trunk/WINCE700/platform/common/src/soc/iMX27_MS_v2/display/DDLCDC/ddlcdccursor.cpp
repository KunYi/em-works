...
//
//------------------------------------------------------------------------------
SCODE MX27DDLcdc::SetPointerShape(GPESurf * pMask, 
                                 GPESurf * pColorSurf, 
                                 int xHot, 
                                 int yHot, 
                                 int cx, 
...
//
//------------------------------------------------------------------------------
SCODE MX27DDLcdc::MovePointer(int x, int y)
{
    CursorOff();
...
//
//------------------------------------------------------------------------------
VOID MX27DDLcdc::CursorOff (void)
{
    UCHAR   *ptrScreen = (UCHAR*)m_pPrimarySurface->Buffer();
    UCHAR   *ptrLine;
    UCHAR   *cbsLine;
...
//
//------------------------------------------------------------------------------
VOID MX27DDLcdc::PointerBltPrepare(GPEBltParms * pBltParms)
{
    RECTL   rectl;
