...
PMIC_STATUS PmicPwrctrlGetPowerCutTimer (UINT8* duration)
{
    ...
    *duration = (UINT8)CSP_BITFEXT(temp, MC13783_PWRCTRL1_PCT);
...
PMIC_STATUS PmicPwrctrlGetPowerCutCounter (UINT8* counter)
{
    ...
    *counter = (UINT8)CSP_BITFEXT(temp, MC13783_PWRCTRL1_PCCOUNT);
...
PMIC_STATUS PmicPwrctrlGetPowerCutMaxCounter (UINT8* counter)
{
    ...
    *counter = (UINT8)CSP_BITFEXT(temp, MC13783_PWRCTRL1_PCMAXCNT);
...
PMIC_STATUS PmicPwrctrlGetMemHoldTimer (UINT8* duration)
{
    ...
    *duration = (UINT8)CSP_BITFEXT(temp, MC13783_PWRCTRL1_MEMTMR);
...
PMIC_STATUS PmicPwrctrlGetRegenAssig (t_regulator regu , UINT8* value)
{
    ...
    *value  =(UINT8)((temp & (((1U << (1)) - 1) << (REGULATOR_REGEN_BIT[regu]))) >> (REGULATOR_REGEN_BIT[regu]));
