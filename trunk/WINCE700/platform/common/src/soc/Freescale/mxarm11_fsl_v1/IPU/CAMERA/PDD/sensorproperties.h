...
{
    {
        ...
        0,                  // Reserved
#if (UNDER_CE > 600)        
        10,                  // Minimum in Millimeters //changed the default value from 1 to 10 in accordance to MSDN
#else
...
#if (UNDER_CE > 600)
const static LONG ZoomDefault = 10; //changed the default value from 1 to 10 in accordance to MSDN
#else
