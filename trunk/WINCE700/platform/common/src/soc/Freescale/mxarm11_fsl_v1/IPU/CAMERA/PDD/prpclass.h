...
#define PRP_MAX_OUTPUT_WIDTH    720
#define PRP_MAX_OUTPUT_HEIGHT   1040
...
class PrpClass : public IpuModuleInterfaceClass
{
    ...
    private:
        ...
        static DWORD PrpIntrThread(LPVOID);
        void PrpISRLoop(UINT32);
        static DWORD PrpEncBufferWorkerThread(LPVOID);
        void PrpEncBufferWorkerRoutine(UINT32);
        static DWORD PrpEncRotBufferWorkerThread(LPVOID);
        void PrpEncRotBufferWorkerRoutine(UINT32);
        static DWORD PrpVfBufferWorkerThread(LPVOID);
        void PrpVfBufferWorkerRoutine(UINT32);
        static DWORD PrpVfRotBufferWorkerThread(LPVOID);
        ...
        //Thread stop status 
        BOOL m_bPrpStopISRThread;
        BOOL m_bPrpStopEncBufThread;
        BOOL m_bPrpStopVfBufThread;
        BOOL m_bPrpStopEncRotBufThread;
        BOOL m_bPrpStopVfRotBufThread;
